...
M00_L02:
       ...
       mov       rcx,r10
       mov       rdx,rsi
       call      qword ptr [7FF7DBEA60A0]; System.Enum.Equals(System.Object)
M00_L03:
       test      eax,eax
       je        near ptr M00_L12
M00_L04:
...
M00_L18:
       ...
       mov       r8,rsi
       mov       rcx,r14
       call      qword ptr [7FF7DC3BC2A0]; System.Collections.Concurrent.ConcurrentDictionary`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].TryAddInternal(Tables<System.__Canon,System.__Canon>, System.__Canon, System.Nullable`1<Int32>, System.__Canon, Boolean, Boolean, System.__Canon ByRef)
...
M01_L00:
       ...
       lea       rsi,[rbx+8]
       lea       rdi,[rdx+8]
       call      00007FF83BB60800
       add       eax,0FFFFFFFE
       cmp       eax,17
       ja        short M01_L03
       lea       rcx,[7FF7DC7B1650]
       mov       ecx,[rcx+rax*4]
       lea       rdx,[M01_L00]
       add       rcx,rdx
       jmp       rcx
...
M02_L00:
       mov       rcx,[rbp-8]
       mov       rdx,[rbp+18]
       call      qword ptr [7FF7DC7251E8]; System.Enum.GetName(System.Type, System.Object)
       mov       [rbp-10],rax
; 			if (name == null)
; 			^^^^^^^^^^^^^^^^^
...
M02_L01:
       ...
       mov       rdx,[rbp-10]
       cmp       [rcx],ecx
       call      qword ptr [7FF7DC725200]; System.Type.GetField(System.String)
       mov       [rbp-18],rax
; 			if (field == null)
; 			^^^^^^^^^^^^^^^^^^
       mov       rcx,[rbp-18]
       xor       edx,edx
       call      qword ptr [7FF7DC725218]; System.Reflection.FieldInfo.op_Equality(System.Reflection.FieldInfo, System.Reflection.FieldInfo)
       test      eax,eax
       je        short M02_L02
; 				return name;
; 				^^^^^^^^^^^^
...
M02_L02:
       mov       rdx,[rbp-18]
       mov       rcx,7FF7DC735230
       xor       r8d,r8d
       call      qword ptr [7FF7DC535998]; System.Reflection.CustomAttributeExtensions.GetCustomAttribute[[System.__Canon, System.Private.CoreLib]](System.Reflection.MemberInfo, Boolean)
       mov       [rbp-20],rax
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,rax
       call      qword ptr [7FF7DC2CE148]; System.String.IsNullOrEmpty(System.String)
       test      eax,eax
       jne       short M02_L03
...
M04_L01:
       ...
       lea       rdx,[rbp-48]
       call      qword ptr [7FF83CF10080]; Precode of System.Threading.Monitor.Enter(System.Object, Boolean ByRef)
M04_L02:
       mov       rcx,[rbp+18]
       mov       r8,[rbp+10]
       cmp       rcx,[r8+8]
...
M04_L03:
       mov       rcx,[r8]
       call      qword ptr [7FF83CF0F740]
       mov       rcx,rax
       call      qword ptr [7FF83CF0F2C0]; CORINFO_HELP_NEWFAST
       mov       r15,rax
       mov       r13,[rbx]
       lea       rcx,[r15+8]
       mov       rdx,[rbp+20]
       call      qword ptr [7FF83CF0F298]; CORINFO_HELP_ASSIGN_REF
       lea       rcx,[r15+10]
       mov       rdx,[rbp+30]
       call      qword ptr [7FF83CF0F298]; CORINFO_HELP_ASSIGN_REF
       lea       rcx,[r15+18]
...
M04_L05:
       ...
       jne       short M04_L06
       mov       rcx,[r8]
       call      qword ptr [7FF83CF0F6E8]
       mov       rcx,rax
       call      qword ptr [7FF83CF0FDF0]
       mov       rdx,[r15+8]
       mov       rcx,[rbp-58]
       mov       r11,rax
       mov       r8,[rbp+20]
...
M04_L07:
       ...
       mov       rcx,[rbp+48]
       mov       rdx,[rbp+30]
       call      qword ptr [7FF83CF0F2A0]; CORINFO_HELP_CHECKED_ASSIGN_REF
M04_L08:
       xor       ecx,ecx
       mov       [rbp-4C],ecx
...
M04_L12:
       call      qword ptr [7FF83CF0F290]
       int       3
M04_L13:
       call      qword ptr [7FF83CF0F288]
       int       3
M04_L14:
       mov       rdx,[r15+10]
       mov       rcx,[rbp+48]
...
M04_L20:
       ...
       call      qword ptr [7FF83CF10088]; Precode of System.Threading.Monitor.Exit(System.Object)
       mov       r8,[rbp+10]
M04_L21:
       mov       ecx,esi
       or        ecx,edi
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.EnumExtensionsBenchmark.GetItems()
       ...
       mov       [rax+8],ecx
       mov       rcx,rax
       call      qword ptr [7FF7DC6AED90]; DotNetTips.Spargine.Extensions.EnumExtensions.GetItems(System.Enum)
       mov       [rsp+28],rax
       mov       rbx,[rbx+60]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       [rbp-78],rcx
       mov       rcx,rbx
       call      qword ptr [7FF7DC2261C0]; System.Object.GetType()
       mov       rbx,rax
       mov       [rbp-0C8],rbx
       mov       rcx,[rbx+18]
       test      cl,2
...
M01_L00:
       ...
       je        near ptr M01_L73
       mov       rcx,rbx
       call      qword ptr [7FF7DC6AEE68]; System.Enum.GetValuesAsUnderlyingTypeNoCopy(System.RuntimeType)
       mov       rdi,rax
       mov       [rbp-0D0],rdi
       mov       ecx,[rdi+8]
       test      ecx,ecx
...
M01_L09:
       ...
       jge       short M01_L15
       mov       ecx,167
       mov       rdx,7FF7DBEC4000
       call      qword ptr [7FF7DBF8F210]
       mov       r8,rax
       mov       edx,[rbp-64]
       mov       ecx,r15d
       call      qword ptr [7FF7DC717768]
       int       3
M01_L10:
       xor       ecx,ecx
...
M01_L18:
       ...
       mov       rcx,rdi
       mov       rdx,r12
       call      qword ptr [7FF7DC6AEF40]; System.Array.CanAssignArrayType(System.Array, System.Array)
       test      eax,eax
...
M01_L21:
       ...
       je        near ptr M01_L73
       mov       rcx,rbx
       call      qword ptr [7FF7DC6ACEE8]; System.Enum.GetNamesNoCopy(System.RuntimeType)
       test      rax,rax
       je        near ptr M01_L33
       lea       rbx,[rax+10]
       mov       esi,[rax+8]
...
M01_L41:
       ...
       call      qword ptr [7FF7DC6AF000]; System.Enum.GetValue()
       test      rax,rax
       je        short M01_L45
       mov       rdx,rax
...
M01_L55:
       ...
       je        short M01_L56
       call      qword ptr [7FF7DBF857A0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       jmp       near ptr M01_L20
M01_L56:
...
M01_L58:
       ...
       call      qword ptr [7FF7DBF8F210]
       mov       rcx,rax
       call      qword ptr [7FF7DC715B18]
       int       3
M01_L59:
       mov       rcx,offset MT_System.RankException
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF7DC7177B0]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF7DC7177C8]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M01_L60:
...
M01_L71:
       ...
       mov       rcx,rdx
       mov       rdx,r10
       call      qword ptr [7FF7DBF866E8]; System.Buffer.MemmoveInternal(Byte ByRef, Byte ByRef, UIntPtr)
       jmp       near ptr M01_L20
M01_L72:
       mov       [rsp+20],ebx
       mov       [rsp+28],eax
       ...
       mov       r8,r12
       mov       r9d,r13d
       call      qword ptr [7FF7DC717840]
       jmp       near ptr M01_L20
M01_L73:
       call      qword ptr [7FF7DC717258]
       int       3
M01_L74:
...
M01_L80:
       mov       rcx,r12
       call      qword ptr [7FF7DC6AFAC8]; System.RuntimeTypeHandle.<InternalAllocNoChecks>g__InternalAllocNoChecksWorker|37_0(System.Runtime.CompilerServices.MethodTable*)
...
M01_L90:
       mov       rcx,r12
       mov       rdx,r13
       call      qword ptr [7FF7DBF85878]; System.Runtime.CompilerServices.CastHelpers.Box_Nullable(System.Runtime.CompilerServices.MethodTable*, Byte ByRef)
       mov       rdx,rax
       mov       r13,rdx
...
M01_L95:
       ...
       lea       rdx,[rbp-0C0]
       mov       rcx,rbx
       call      qword ptr [7FF7DC717210]
       jmp       near ptr M01_L47
M01_L96:
       mov       ecx,3A
       call      qword ptr [7FF7DC717108]
       int       3
M01_L97:
       mov       ecx,43
       call      qword ptr [7FF7DC6A5EA8]
       int       3
M01_L98:
       mov       edx,4
...
M01_L99:
       ...
       mov       r8d,r15d
       mov       rdx,r13
       call      qword ptr [7FF7DBF8F588]; System.Array.Copy(System.Array, System.Array, Int32)
M01_L100:
       lea       rcx,[rsi+8]
       mov       rdx,r13
       call      CORINFO_HELP_ASSIGN_REF
...
M01_L105:
       ...
       xor       edx,edx
       mov       [rsp+28],edx
       call      qword ptr [7FF7DC6AEF28]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M01_L52
M01_L106:
       call      CORINFO_HELP_RNGCHKFAIL
       int       3
