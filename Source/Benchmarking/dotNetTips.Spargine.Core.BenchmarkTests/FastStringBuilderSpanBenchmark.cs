...
//     David McCarter
// </copyright>
// <summary>Micro-benchmarks for the span-aware FastStringBuilder APIs added to improve zero-allocation scenarios.</summary>
// ***********************************************************************
...
public class FastStringBuilderSpanBenchmark : Benchmark
{
	...
	[Benchmark(Description = nameof(FastStringBuilder.Combine) + " Span")]
	...
	[Benchmark(Description = nameof(FastStringBuilder.CombineWithSpace) + " Span")]
	public void CombineWithSpaceSpan()
	{
	...
	[Benchmark(Description = nameof(FastStringBuilder.Concat) + " Span")]
	public void ConcatSpan()
	{
		var result = FastStringBuilder.Concat(ControlChars.Comma, false, this._words);

		this.Consume(result);
	}

	[Benchmark(Description = nameof(FastStringBuilder.PerformAction) + " Span")]
	public void PerformActionSpan()
	{
