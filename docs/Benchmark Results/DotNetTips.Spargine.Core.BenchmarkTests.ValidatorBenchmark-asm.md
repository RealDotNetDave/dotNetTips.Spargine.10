...
; DotNetTips.Spargine.Core.BenchmarkTests.ValidatorBenchmark.CheckItemsExists_Validation_Inlining()
       ...
       je        short M00_L00
       mov       rcx,rsi
       call      qword ptr [7FFC6CDECAF8]; DotNetTips.Spargine.Core.Extensions.Count(System.Collections.IEnumerable)
M00_L00:
       mov       [rsp+20],rsi
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+20]
...
M01_L02:
       ...
       mov       rcx,rdi
       call      qword ptr [7FFC6CE1CC68]; Precode of System.Linq.Enumerable+IEnumerableWhereIterator`1[[System.__Canon, System.Private.CoreLib]].MoveNext()
M01_L03:
       test      eax,eax
       jne       short M01_L01
...
M01_L10:
       ...
       jne       short M01_L11
       mov       rcx,rbx
       call      qword ptr [7FFC6CDECB10]; System.Linq.Enumerable+Iterator`1[[System.__Canon, System.Private.CoreLib]].GetEnumerator()
       mov       rdi,rax
       jmp       short M01_L12
M01_L11:
       mov       rcx,rbx
       mov       r11,7FFC6C7809C0
       call      qword ptr [r11]
       mov       rdi,rax
M01_L12:
...
; DotNetTips.Spargine.Core.BenchmarkTests.ValidatorBenchmark.CheckItemsExists_Validation()
       ...
       je        short M00_L00
       mov       rcx,rsi
       call      qword ptr [7FFC6CE1CAF8]; DotNetTips.Spargine.Core.Extensions.Count(System.Collections.IEnumerable)
M00_L00:
       mov       [rsp+20],rsi
       mov       rbx,[rbx+18]
       mov       rdx,[rsp+20]
...
M01_L07:
       ...
       jne       short M01_L08
       mov       rcx,rbx
       call      qword ptr [7FFC6CE1CB10]; System.Linq.Enumerable+Iterator`1[[System.__Canon, System.Private.CoreLib]].GetEnumerator()
       mov       rdi,rax
       jmp       short M01_L09
M01_L08:
       mov       rcx,rbx
       mov       r11,7FFC6C7B09C0
       call      qword ptr [r11]
       mov       rdi,rax
M01_L09:
       jmp       short M01_L11
...
M01_L11:
       ...
       jne       short M01_L12
       mov       rcx,rdi
       call      qword ptr [7FFC6CE4CC68]; Precode of System.Linq.Enumerable+IEnumerableWhereIterator`1[[System.__Canon, System.Private.CoreLib]].MoveNext()
       jmp       short M01_L13
M01_L12:
       mov       rcx,rdi
       mov       r11,7FFC6C7B09C8
       call      qword ptr [r11]
M01_L13:
       test      eax,eax
       jne       short M01_L10
...
; DotNetTips.Spargine.Core.BenchmarkTests.ValidatorBenchmark.ArgumentDefined()
       ...
       mov       rdx,rax
       mov       rcx,16EBBB306A0
       call      qword ptr [7FFC6C7BA5D0]; System.RuntimeType.IsEnumDefined(System.Object)
       test      eax,eax
       je        short M00_L00
       ...
       cmp       [rcx],cl
       lea       rcx,[rsp+20]
       call      qword ptr [7FFC6CF673C0]; BenchmarkDotNet.Engines.DeadCodeEliminationHelper.KeepAliveWithoutBoxingReadonly[[DotNetTips.Spargine.Core.Status, DotNetTips.Spargine.10.Core]](DotNetTips.Spargine.Core.Status ByRef)
       nop
       add       rsp,28
       pop       rbx
       pop       rsi
       ret
M00_L00:
       call      qword ptr [7FFC6CF672B8]
       mov       rbx,rax
       test      rbx,rbx
       jne       short M00_L01
       call      qword ptr [7FFC6D034648]
       mov       rbx,rax
M00_L01:
...
M01_L01:
       ...
       je        near ptr M01_L26
       mov       rcx,rsi
       call      qword ptr [7FFC6C87C9C0]; System.Object.GetType()
       mov       rdi,rax
       mov       rcx,[rdi+18]
       test      cl,2
...
M01_L17:
       mov       rcx,rdi
       call      qword ptr [7FFC6C877C60]; System.RuntimeType.InitializeCache()
       jmp       near ptr M01_L07
M01_L18:
       cmp       ebp,0A
       ja        near ptr M01_L50
       mov       edx,ebp
       lea       rcx,[7FFC6C93D718]
       mov       ecx,[rcx+rdx*4]
       lea       rax,[M01_L00]
       add       rcx,rax
       jmp       rcx
...
M01_L23:
       mov       rcx,rbx
       xor       edx,edx
       call      qword ptr [7FFC6CE2D098]; System.Enum.<GetEnumInfo>g__InitializeEnumInfo|5_0[[System.UInt32, System.Private.CoreLib]](System.RuntimeType, Boolean)
...
M01_L24:
       ...
       mov       rcx,rax
       call      qword ptr [7FFC6CF6F7E0]
       int       3
M01_L25:
       mov       rcx,rdi
       mov       rdx,rbx
       call      qword ptr [7FFC6CF6FCA8]
       test      eax,eax
       jne       near ptr M01_L03
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rbp,rax
       call      qword ptr [7FFC6CF6FC48]
       mov       rcx,rax
       mov       rdx,rdi
       mov       r8,rbx
       call      qword ptr [7FFC6CF6FC60]
       mov       rdx,rax
       mov       rcx,rbp
       call      qword ptr [7FFC6CE2EBB0]
       mov       rcx,rbp
       call      CORINFO_HELP_THROW
       int       3
M01_L26:
       call      qword ptr [7FFC6CF6FC30]
       int       3
M01_L27:
       mov       rcx,rbx
       call      qword ptr [7FFC6CF65398]; System.Enum.GetNamesNoCopy(System.RuntimeType)
       mov       rbx,rax
       mov       rdx,rsi
       ...
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,7FFC6CFC7E08
       call      qword ptr [7FFC6CF672D0]
       not       eax
       shr       eax,1F
       add       rsp,28
       pop       rbx
...
M01_L28:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFC6CF6FC78]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FFC6CE2FE28]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M01_L29:
...
M01_L30:
       mov       rbp,rdi
       mov       rcx,rbp
       call      qword ptr [7FFC6CA1F288]; System.RuntimeType.get_IsActualEnum()
       test      eax,eax
       je        short M01_L31
       mov       rcx,rdi
       call      qword ptr [7FFC6C7BA588]; Precode of System.RuntimeType.GetEnumUnderlyingType()
       mov       rbp,rax
       test      rbp,rbp
       je        short M01_L31
...
M01_L53:
       ...
       mov       edx,r8d
       mov       r8d,esi
       call      qword ptr [7FFC6CF6FF18]
       jmp       short M01_L55
M01_L54:
       mov       rcx,rax
       mov       edx,esi
       call      qword ptr [7FFC6D034240]; System.SpanHelpers.NonPackedIndexOfValueType[[System.Int32, System.Private.CoreLib],[System.SpanHelpers+DontNegate`1[[System.Int32, System.Private.CoreLib]], System.Private.CoreLib]](Int32 ByRef, Int32, Int32)
M01_L55:
       not       eax
       shr       eax,1F
       jmp       near ptr M01_L13
       ...
       mov       edx,[rax]
       mov       rcx,rbx
       call      qword ptr [7FFC6CF67330]; System.Enum.IsDefinedPrimitive[[System.UInt32, System.Private.CoreLib]](System.RuntimeType, UInt32)
       jmp       near ptr M01_L13
       mov       rdx,rsi
