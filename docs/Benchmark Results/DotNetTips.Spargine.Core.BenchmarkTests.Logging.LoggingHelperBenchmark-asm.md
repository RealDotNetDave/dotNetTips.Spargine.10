...
; DotNetTips.Spargine.Core.BenchmarkTests.Logging.LoggingHelperBenchmark.RetrieveAllExceptionMessages()
       ...
       mov       rcx,rdi
       call      qword ptr [7FFB6A5AF930]; DotNetTips.Spargine.Core.Logging.LoggingHelper.RetrieveAllExceptions(System.Exception)
       mov       rsi,rax
       mov       rcx,242CE800158
       mov       rdi,[rcx]
       test      rdi,rdi
...
M00_L19:
       ...
       int       3
M00_L20:
       mov       r11,7FFB69E20B28
       call      qword ptr [r11]
       mov       edi,eax
       jmp       near ptr M00_L02
M00_L21:
       mov       r11,7FFB69E20B20
       call      qword ptr [r11]
       mov       edi,eax
       jmp       near ptr M00_L02
M00_L22:
...
M00_L25:
       ...
       mov       r8d,[rbp+10]
       mov       rdx,r14
       call      qword ptr [7FFB6A044FD8]; System.Array.Copy(System.Array, System.Array, Int32)
...
M01_L02:
       mov       rcx,rsi
       mov       rdx,rbx
       call      qword ptr [7FFB6A04E370]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].AddWithResize(System.__Canon)
       jmp       short M01_L01
M01_L03:
       call      qword ptr [7FFB6A4DE298]
       mov       ecx,1D35
       ...
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FFB69ED7858]; System.String.Concat(System.String, System.String)
       mov       rbx,rax
       mov       ecx,110B
       mov       rdx,7FFB6A214870
       call      qword ptr [7FFB6A0F7738]
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FFB6A63CC30]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FFB6A637D68]
       mov       rcx,rsi
...
M03_L05:
       pop       rbx
       pop       rsi
       jmp       qword ptr [7FFB69EDD908]; System.Runtime.CompilerServices.CastHelpers.IsInstanceOfAny_NoCacheLookup(Void*, System.Object)
...
M04_L03:
       mov       rcx,rax
       cmp       [rcx],ecx
       call      qword ptr [7FFB6A637690]
       mov       rdx,rax
       mov       rcx,rsi
       add       rsp,28
       pop       rbx
       pop       rsi
       jmp       qword ptr [7FFB6A6376A8]
...
M08_L01:
       test      rbx,rbx
       jne       short M08_L04
       mov       rcx,7FFB6A649B8C
       call      CORINFO_HELP_COUNTPROFILE32
M08_L02:
       mov       rcx,7FFB6A649B94
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,[rsi]
       mov       ecx,[rcx+4]
       add       ecx,0FFFFFFE8
...
M08_L04:
       ...
       cmp       r15,[rbx]
       je        short M08_L05
       mov       rcx,7FFB6A649B88
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M08_L02
M08_L05:
       cmp       dword ptr [r15+4],18
       je        short M08_L06
       mov       rcx,7FFB6A649B84
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M08_L02
M08_L06:
       cmp       edi,[rsi+8]
       jbe       short M08_L07
       mov       rcx,7FFB6A649B80
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M08_L02
M08_L07:
       cmp       edi,[rbx+8]
       jbe       near ptr M08_L13
       mov       rcx,7FFB6A649B7C
       call      CORINFO_HELP_COUNTPROFILE32
...
M08_L10:
       ...
       mov       r8,rbx
       mov       r9d,r15d
       call      qword ptr [7FFB6A635770]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
M08_L11:
       nop
       add       rsp,38
       pop       rbx
...
M08_L14:
       ...
       pop       r14
       pop       r15
       jmp       qword ptr [7FFB6A4DDC50]
M08_L15:
       mov       rcx,7FFB6A649B90
       call      CORINFO_HELP_COUNTPROFILE32
       cmp       rdi,19
       jne       short M08_L16
...
M01_L05:
       mov       rdx,7FFB6A63A7E8
       call      qword ptr [7FFB69EFC5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       short M01_L01
M01_L06:
       mov       ecx,7
       mov       edx,0F
       call      qword ptr [7FFB6A4F59B0]
       int       3
M01_L07:
       mov       rcx,r14
       mov       r8d,edi
       mov       rdx,r15
       call      qword ptr [7FFB6A064FD8]; System.Array.Copy(System.Array, System.Array, Int32)
       jmp       short M01_L02
M01_L08:
       mov       rcx,[rbx]
       mov       rdx,[rcx+30]
...
; System.Runtime.CompilerServices.CastHelpers.StelemRef(System.Object[], IntPtr, System.Object)
       ...
       mov       rcx,rax
       add       rsp,28
       jmp       qword ptr [7FFB69EFD8F0]; System.Runtime.CompilerServices.CastHelpers.StelemRef_Helper(System.Object ByRef, Void*, System.Object)
M02_L00:
       call      qword ptr [7FFB6A654C48]
       int       3
M02_L01:
       mov       rcx,rax
       mov       rdx,r8
