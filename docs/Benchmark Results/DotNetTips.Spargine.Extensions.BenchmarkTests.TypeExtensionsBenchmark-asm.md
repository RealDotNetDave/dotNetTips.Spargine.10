...
; DotNetTips.Spargine.Extensions.BenchmarkTests.TypeExtensionsBenchmark.GetTypeMembersWithAttribute()
       ...
       mov       [rsi+18],rdx
       mov       rdx,rsi
       mov       rcx,7FF8A797A0A8
       call      qword ptr [7FF8A78EEEE0]; System.Linq.Enumerable.<ToArray>g__EnumerableToArray|324_0[[System.__Canon, System.Private.CoreLib]](System.Collections.Generic.IEnumerable`1<System.__Canon>)
       mov       rsi,rax
...
M01_L05:
       mov       rcx,rdi
       mov       rdx,7FF8A7A76AC0
       call      qword ptr [7FF8A723C5D0]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       r11,rax
       jmp       short M01_L04
M01_L06:
       lea       rcx,[rbp-188]
...
M01_L13:
       mov       rcx,rbx
       mov       rdx,7FF8A7A76BA8
       call      qword ptr [7FF8A723C5D0]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       short M01_L09
M01_L14:
       mov       rdx,7FF8A7A77188
       call      qword ptr [7FF8A74B7AF8]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       rdx,rax
       jmp       short M01_L10
M01_L15:
       mov       rcx,[rbx+30]
...
M01_L21:
       call      qword ptr [7FF8A73D7138]
       int       3
M01_L22:
       mov       rcx,rbx
       mov       rdx,7FF8A7A76BE0
       call      qword ptr [7FF8A723C5D0]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       near ptr M01_L16
M01_L23:
       mov       rdx,7FF8A7A76E48
       call      qword ptr [7FF8A74B7AF8]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       near ptr M01_L17
M01_L24:
       mov       rcx,rbx
       mov       rdx,7FF8A7A76D48
       call      qword ptr [7FF8A723C5D0]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       near ptr M01_L18
M01_L25:
       mov       rdx,7FF8A7A73090
       call      qword ptr [7FF8A723C5D0]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
...
M01_L26:
       ...
       mov       r8,r12
       mov       rcx,r14
       call      qword ptr [7FF8A72357A0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       add       r14,r12
       sub       edi,r13d
       mov       r12d,edi
       mov       r13,r14
...
M01_L27:
       ...
       ja        near ptr M01_L40
       mov       rcx,r13
       call      00007FF906E35D60
       cmp       dword ptr [7FF90719F778],0
       je        near ptr M01_L11
       jmp       near ptr M01_L39
M01_L28:
       call      qword ptr [7FF8A76CC2A0]
       int       3
M01_L29:
       mov       rdx,7FF8A7A76678
       call      qword ptr [7FF8A74B7AF8]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       rsi,rax
       jmp       near ptr M01_L01
M01_L30:
       mov       rcx,rdi
       mov       rdx,7FF8A7A76AA8
       call      qword ptr [7FF8A723C5D0]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       r11,rax
       jmp       near ptr M01_L02
M01_L31:
       mov       ecx,11
       call      qword ptr [7FF8A74B7DF8]
       int       3
M01_L32:
       call      qword ptr [7FF8A7A0C900]
       int       3
M01_L33:
       mov       rcx,[rbx+30]
       mov       rcx,[rcx]
...
M01_L40:
       mov       rcx,r13
       call      qword ptr [7FF8A783E0B8]
       jmp       near ptr M01_L11
M01_L41:
       lea       rcx,[rbp-188]
       call      qword ptr [7FF8A7A0CE40]
