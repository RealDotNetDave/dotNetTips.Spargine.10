...
M00_L06:
       mov       ecx,2
       call      qword ptr [7FFE507A4108]; System.Runtime.CompilerServices.StaticsHelpers.GetOptimizedGCThreadStaticBase(Int32)
       jmp       near ptr M00_L00
M00_L07:
       call      qword ptr [7FFE500ED4B8]; System.Globalization.CultureInfo.InitializeUserDefaultCulture()
       mov       rsi,rax
       jmp       short M00_L01
M00_L08:
       ...
       mov       rdx,[rsi+30]
       mov       rcx,rdi
       call      qword ptr [7FFE507072E8]; System.Globalization.TextInfo..ctor(System.Globalization.CultureData)
...
M00_L10:
       mov       rcx,rdi
       call      qword ptr [7FFE5070D788]; System.Globalization.TextInfo.PopulateIsAsciiCasingSameAsInvariant()
       jmp       near ptr M00_L04
M00_L11:
       mov       rcx,rdi
       mov       edx,41
       xor       r8d,r8d
       call      qword ptr [7FFE507A4A50]
       mov       esi,eax
...
; System.Globalization.TextInfo.PopulateIsAsciiCasingSameAsInvariant()
       ...
       mov       rbx,rcx
       mov       rcx,[rbx+18]
       call      qword ptr [7FFE74E1B9D8]; Precode of System.Globalization.CultureInfo.GetCultureInfo(System.String)
       mov       rcx,rax
       ...
       mov       r9d,1
       cmp       [rcx],ecx
       call      qword ptr [7FFE74E1B228]; Precode of System.Globalization.CompareInfo.Compare(System.String, System.String, System.Globalization.CompareOptions)
       mov       ecx,2
       mov       edx,1
       test      eax,eax
       cmovne    ecx,edx
...
M00_L07:
       mov       ecx,2
       call      qword ptr [7FFE50774138]; System.Runtime.CompilerServices.StaticsHelpers.GetOptimizedGCThreadStaticBase(Int32)
       jmp       near ptr M00_L00
M00_L08:
       call      qword ptr [7FFE500BD4B8]; System.Globalization.CultureInfo.InitializeUserDefaultCulture()
       mov       rsi,rax
       jmp       short M00_L01
M00_L09:
       mov       rcx,offset MT_System.Globalization.TextInfo
       ...
       mov       rdx,[rsi+30]
       mov       rcx,rdi
       call      qword ptr [7FFE506D7318]; System.Globalization.TextInfo..ctor(System.Globalization.CultureData)
       movzx     ecx,byte ptr [rsi+60]
       mov       [rdi+30],cl
       lea       rcx,[rsi+10]
       mov       rdx,rdi
...
M00_L11:
       mov       rcx,rdi
       call      qword ptr [7FFE506DD7B8]; System.Globalization.TextInfo.PopulateIsAsciiCasingSameAsInvariant()
       jmp       near ptr M00_L04
