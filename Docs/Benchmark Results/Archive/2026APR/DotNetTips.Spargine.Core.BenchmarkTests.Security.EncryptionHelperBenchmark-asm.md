...
M00_L04:
       ...
       mov       rcx,r12
       mov       edx,eax
       call      qword ptr [7FF9977E7AE0]; System.Text.Unicode.Utf16Utility.GetPointerToFirstInvalidChar(Char*, Int32, Int64 ByRef, Int32 ByRef)
       sub       rax,r12
       mov       r9,rax
       shr       r9,3F
       add       r9,rax
...
M00_L09:
       ...
       jne       short M00_L10
       mov       rcx,r15
       call      qword ptr [7FF997A7C0C0]; System.Threading.Monitor.Enter_Slowpath(System.Object)
M00_L10:
       mov       rcx,[r15+8]
       mov       eax,[r15+10]
       dec       eax
...
M00_L33:
       ...
       call      qword ptr [7FF997E6AD60]; System.Buffers.SharedArrayPool`1[[System.Byte, System.Private.CoreLib]].Rent(Int32)
       mov       rdx,rax
M00_L34:
       mov       [rbp-290],rdx
       mov       [rbp-330],r12
...
M00_L47:
       ...
       mov       [rbp-128],rcx
       mov       edx,0C
       call      qword ptr [7FF997D6F018]; System.Security.Cryptography.RandomNumberGeneratorImplementation.GetBytes(Byte*, Int32)
       xor       r9d,r9d
       mov       [rbp-128],r9
       test      r13d,r13d
       jle       short M00_L49
...
M00_L48:
       ...
       call      qword ptr [7FF997EAE958]; System.Text.UTF8Encoding.GetBytesCommon(Char*, Int32, Byte*, Int32, Boolean)
       xor       ecx,ecx
       mov       [rbp-130],rcx
       mov       [rbp-138],rcx
       mov       [rbp-3C],eax
M00_L49:
       ...
       mov       rdx,[rbp-278]
       mov       r8d,10
       call      qword ptr [7FF997E3D368]; System.Security.Cryptography.AesGcm..ctor(Byte[], Int32)
       mov       [rbp-2A0],rsi
       ...
       xor       r8d,r8d
       mov       r9d,0C
       call      qword ptr [7FF997E3CA98]; System.Span`1[[System.Byte, System.Private.CoreLib]]..ctor(Byte[], Int32, Int32)
       mov       rdx,[rbp-148]
       mov       r8d,[rbp-140]
       vxorps    xmm0,xmm0,xmm0
       vmovdqu   xmmword ptr [rbp-158],xmm0
       lea       rcx,[rbp-158]
       call      qword ptr [7FF997EAE970]; System.ReadOnlySpan`1[[System.Byte, System.Private.CoreLib]]..ctor(Byte ByRef, Int32)
       mov       r15,[rbp-158]
       mov       r13d,[rbp-150]
       vxorps    xmm0,xmm0,xmm0
       ...
       lea       rdx,[rbp-238]
       lea       rcx,[rbp-50]
       call      qword ptr [7FF997BF7F48]; System.Span`1[[System.Byte, System.Private.CoreLib]].op_Implicit(System.Span`1<Byte>)
       vxorps    xmm0,xmm0,xmm0
       ...
       lea       r8,[rbp-50]
       mov       rcx,rsi
       call      qword ptr [7FF997E3D380]; System.Security.Cryptography.AesGcm.Encrypt(System.ReadOnlySpan`1<Byte>, System.ReadOnlySpan`1<Byte>, System.Span`1<Byte>, System.Span`1<Byte>, System.ReadOnlySpan`1<Byte>)
       nop
       mov       rcx,[rsi+8]
       cmp       [rcx],ecx
       call      qword ptr [7FF997957700]; System.Runtime.InteropServices.SafeHandle.Dispose()
       mov       esi,[rbp-3C]
       add       esi,0D
       jo        near ptr M00_L54
       mov       r9d,esi
       ...
       mov       r8d,1
       mov       r9d,0C
       call      qword ptr [7FF997BF7F30]; System.Span`1[[System.Byte, System.Private.CoreLib]].Slice(Int32, Int32)
       lea       rcx,[rbp-78]
       lea       rdx,[rbp-88]
       call      qword ptr [7FF997E376D8]; System.Span`1[[System.Byte, System.Private.CoreLib]].CopyTo(System.Span`1<Byte>)
       vxorps    xmm0,xmm0,xmm0
       ...
       xor       edx,edx
       xor       r9d,r9d
       call      qword ptr [7FF997E3D4E8]; System.Convert.ToBase64String(Byte[], Int32, Int32, System.Base64FormattingOptions)
       mov       [rbp-2B0],rax
       jmp       short M00_L51
M00_L50:
...
M00_L51:
       ...
       vmovdqu   xmmword ptr [rbp-238],xmm0
       lea       rcx,[rbp-238]
       call      qword ptr [7FF997E3CAB0]; System.Security.Cryptography.CryptographicOperations.ZeroMemory(System.Span`1<Byte>)
       mov       rcx,r12
       mov       rdx,[rbp-2A8]
       mov       r8d,1
       call      qword ptr [7FF997E6AD68]; System.Buffers.SharedArrayPool`1[[System.Byte, System.Private.CoreLib]].Return(Byte[], Boolean)
       jmp       short M00_L55
M00_L52:
...
M00_L55:
       ...
       mov       rcx,[rcx+60]
       lea       r8,[rbp-220]
       mov       rdx,7FF997EB8FE8
       cmp       [rcx],ecx
       call      qword ptr [7FF997EA5038]; BenchmarkDotNet.Engines.Consumer.Consume[[System.__Canon, System.Private.CoreLib]](System.__Canon ByRef)
       nop
       add       rsp,338
       pop       rbx
       pop       rsi
       ...
       ret
M00_L56:
       call      qword ptr [7FF997BF4378]
       mov       rbx,rax
       test      rbx,rbx
       jne       short M00_L57
       call      qword ptr [7FF997EADC50]
       mov       rbx,rax
M00_L57:
       ...
       mov       r8,rbx
       mov       rdx,2777FACFF88
       call      qword ptr [7FF997EAD800]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
M00_L58:
       mov       ecx,eax
       call      qword ptr [7FF997EAC2E8]
       test      eax,eax
       jne       short M00_L60
...
M00_L60:
       mov       rcx,rbx
       mov       edx,3
       call      qword ptr [7FF997EAC300]
       mov       rbx,rax
       jmp       near ptr M00_L04
M00_L61:
       call      qword ptr [7FF997E37F18]
       mov       rbx,rax
       test      rbx,rbx
       jne       short M00_L62
       call      qword ptr [7FF997EADC50]
...
M00_L67:
       mov       ecx,9
       call      qword ptr [7FF997EAC5D0]; System.Runtime.CompilerServices.StaticsHelpers.GetOptimizedGCThreadStaticBase(Int32)
       mov       r9,rax
       jmp       near ptr M00_L06
M00_L68:
       mov       [rbp-2D0],r11
       mov       rcx,r11
       call      qword ptr [7FF997BFCC60]; System.Runtime.CompilerServices.RuntimeHelpers.GetHashCode(System.Object)
       mov       [rbp-0DC],eax
       mov       rdx,[rbp-2D0]
       mov       r8d,[rdx+8]
       mov       [rbp-0E0],r8d
...
M01_L05:
       ...
       cmp       edx,8
       jl        short M01_L08
       vbroadcastss xmm0,dword ptr [7FF997F36F28]
       vbroadcastss xmm1,dword ptr [7FF997F36F2C]
       vbroadcastss xmm2,dword ptr [7FF997F36F30]
       lea       rdx,[r11-10]
M01_L06:
       vmovups   xmm3,[rcx]
       add       rcx,10
...
M01_L12:
       ...
       ret
M01_L13:
       vbroadcastss xmm0,dword ptr [7FF997F36F34]
...
M01_L14:
       ...
       jmp       short M01_L14
M01_L15:
       vbroadcastss ymm0,dword ptr [7FF997F36F34]
...
; System.Text.UTF8Encoding.GetBytesCommon(Char*, Int32, Byte*, Int32, Boolean)
       ...
       mov       r8,rdi
       mov       r9d,[rbp+30]
       call      qword ptr [7FF9977E7C00]; System.Text.Unicode.Utf8Utility.TranscodeToUtf8(Char*, Int32, Byte*, Int32, Char* ByRef, Byte* ByRef)
       mov       rcx,[rbp-30]
       sub       rcx,rbx
       mov       rdx,rcx
       shr       rdx,3F
...
; System.Security.Cryptography.AesGcm..ctor(Byte[], Int32)
       ...
       mov       [rsp+28],edx
       lea       rdx,[rsp+20]
       call      qword ptr [7FF997E3D3C8]; System.Security.Cryptography.AesGcm..ctor(System.ReadOnlySpan`1<Byte>, Int32)
       nop
       add       rsp,30
       pop       rbx
       ret
M06_L00:
       ...
       mov       rbx,rax
       mov       ecx,4BF3
       mov       rdx,7FF997C0DB08
       call      qword ptr [7FF9977EF210]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF997B658A8]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
...
M10_L00:
       ...
       mov       rdx,[rdx]
       lea       r8,[rbp-40]
       call      qword ptr [7FF997E3C120]; System.Security.Cryptography.KeySizeHelpers.IsLegalSize(Int32, System.Security.Cryptography.KeySizes, Boolean ByRef)
       test      eax,eax
       jne       short M10_L02
...
M10_L25:
       ...
       mov       rcx,[rbx+18]
       cmp       [rcx],ecx
       call      qword ptr [7FF997E3D2C0]; System.Runtime.InteropServices.SafeHandle.DangerousRelease()
       xor       ecx,ecx
       mov       [rbx+18],rcx
M10_L26:
       mov       rcx,[rbx+8]
       call      00007FF9977D93E0
       jmp       short M10_L28
M10_L27:
       mov       rcx,rbx
       mov       rax,[rbx]
...
M11_L00:
       ...
       add       rsp,20
       pop       rbx
       jmp       qword ptr [7FF9979B5578]; System.GC.SuppressFinalize(System.Object)
M11_L01:
       mov       rcx,rbx
       mov       edx,1
       mov       rax,[rbx]
...
M14_L03:
       ...
       cmp       rax,r9
       jb        near ptr M14_L06
       vmovups   ymm0,[7FF997F40D60]
       vpermd    ymm0,ymm0,[rsi]
       add       rsi,0FFFFFFFFFFFFFFFC
M14_L04:
       vpshufb   ymm0,ymm0,[7FF997F40D80]
       vpand     ymm1,ymm0,[7FF997F40DA0]
       vpmulhuw  ymm1,ymm1,[7FF997F40DC0]
       vpand     ymm0,ymm0,[7FF997F40DE0]
       vpmullw   ymm0,ymm0,[7FF997F40E00]
       vpor      ymm0,ymm0,ymm1
       vpsubusb  ymm1,ymm0,[7FF997F40E20]
       vpcmpgtb  ymm2,ymm0,[7FF997F40E40]
       vpsubb    ymm1,ymm1,ymm2
       vbroadcastf128 ymm2,xmmword ptr [7FF997F40E60]
...
M14_L06:
       ...
       cmp       rax,r9
       jb        near ptr M14_L08
       vmovups   xmm0,[7FF997F40E70]
       vmovups   xmm1,[7FF997F40E60]
       vbroadcastss xmm2,dword ptr [7FF997F40DA0]
       vbroadcastss xmm3,dword ptr [7FF997F40DE0]
       vbroadcastss xmm4,dword ptr [7FF997F40DC0]
       vbroadcastss xmm5,dword ptr [7FF997F40E00]
       vbroadcastss xmm6,dword ptr [7FF997F40E20]
       vbroadcastss xmm7,dword ptr [7FF997F40E40]
M14_L07:
       vmovups   xmm8,[r9]
...
; System.Security.Cryptography.CryptographicOperations.ZeroMemory(System.Span`1<Byte>)
       ...
       mov       [rbp+10],rcx
       mov       rcx,[rbp+10]
       call      qword ptr [7FF9FAD7AC48]; Precode of System.Span`1[[System.Byte, System.Private.CoreLib]].Clear()
       nop
       add       rsp,20
       pop       rbp
       ret
...
M16_L16:
       mov       rcx,rdi
       call      qword ptr [7FF997E3CAE0]; System.Buffers.SharedArrayPool`1[[System.Byte, System.Private.CoreLib]].InitializeTlsBucketsAndTrimming()
       mov       r14,rax
...
M16_L18:
       shr       rdx,3
       mov       rcx,rax
       call      qword ptr [7FF997EAD968]
       jmp       near ptr M16_L02
M16_L19:
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       r15,rax
       call      qword ptr [7FF997EAD938]
       mov       r13,rax
       mov       ecx,29B
       mov       rdx,7FF997724000
       call      qword ptr [7FF9977EF210]
...
M16_L20:
       ...
       mov       rcx,rdi
       mov       edx,ebp
       call      qword ptr [7FF997E3CC00]; System.Buffers.SharedArrayPool`1[[System.Byte, System.Private.CoreLib]].CreatePerCorePartitions(Int32)
...
; DotNetTips.Spargine.Core.BenchmarkTests.Security.EncryptionHelperBenchmark.GenerateRandomKey()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FF997EB5098]; DotNetTips.Spargine.Core.Ulid.NewUlid()
       mov       [rsp+28],rax
       mov       rbx,[rbx+60]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; 		^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       lea       rdi,[rbp+30]
       lea       rcx,[rbp+20]
       call      qword ptr [7FF997E45968]; System.DateTimeOffset.get_UtcNow()
...
M01_L01:
       ...
       mov       rcx,rdi
       mov       edx,0A
       call      qword ptr [7FF997D7F000]; System.Security.Cryptography.RandomNumberGeneratorImplementation.GetBytes(Byte*, Int32)
       xor       ecx,ecx
       mov       [rbp+10],rcx
       mov       [rbp+10],rcx
       xor       eax,eax
...
M01_L03:
       ...
       mov       rdx,rax
       lea       rcx,[rbp+18]
       call      qword ptr [7FF997EB50F8]; DotNetTips.Spargine.Core.Ulid..ctor(System.String)
       mov       rax,[rbp+18]
       mov       r8,0E0676066A0EA
       cmp       [rbp+48],r8
       je        short M01_L04
