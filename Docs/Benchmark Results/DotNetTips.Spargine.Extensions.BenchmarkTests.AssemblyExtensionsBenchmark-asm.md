...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetInstances()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FFD57B9D860]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rsi,rax
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetTypes()
       ...
       mov       [rsp+20],rax
       mov       rbx,rcx
       call      qword ptr [7FFD57BBD7B8]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rcx,rax
       call      qword ptr [7FFD57BBD818]; DotNetTips.Spargine.Extensions.AssemblyExtensionsHelper.GetLoadableTypes(System.Reflection.Assembly)
       mov       rsi,rax
...
M00_L03:
       ...
       mov       r8d,1
       call      qword ptr [7FFD57764C00]; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       mov       r15d,eax
...
M00_L05:
       ...
       jne       short M00_L07
       mov       rcx,23B5FF67000
       call      qword ptr [7FFD577669B8]; System.RuntimeType.get_IsActualInterface()
       test      eax,eax
       jne       near ptr M00_L16
       mov       rcx,23B5FF67000
       call      00007FFDB71CAB00
       test      eax,eax
       je        short M00_L08
       mov       rcx,23B5FF67000
       call      qword ptr [7FFD574DA400]
       mov       r15d,[rax+8]
       test      r15d,r15d
       jle       short M00_L07
       lea       r13,[rax+10]
...
M00_L22:
       mov       rcx,rdi
       mov       rdx,r14
       call      qword ptr [7FFD575971C8]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].AddWithResize(System.__Canon)
...
; 				               
       ...
       cmp       [rcx],rax
       jne       short M02_L01
       call      qword ptr [7FFD57703088]; System.Reflection.Assembly.GetTypes()
M02_L00:
       mov       [rbp-20],rax
       jmp       short M02_L02
M02_L01:
...
M02_L02:
       ...
       ret
M02_L03:
       call      qword ptr [7FFD57B1EB50]
       mov       ecx,53
       mov       rdx,7FFD5796C218
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FFD57C66010]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FFD57C65350]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
       sub       rsp,28
       cmp       [rcx],ecx
       call      qword ptr [7FFD57BBD908]
       mov       rbx,rax
       test      byte ptr [7FFD57C13908],1
       jne       short M02_L04
...
M02_L05:
       mov       rdx,rbx
       mov       rcx,7FFD57C13A58
       call      qword ptr [7FFD57914648]; System.Linq.Enumerable.Where[[System.__Canon, System.Private.CoreLib]](System.Collections.Generic.IEnumerable`1<System.__Canon>, System.Func`2<System.__Canon,Boolean>)
       mov       rdx,rax
       mov       rcx,7FFD57C13B70
       call      qword ptr [7FFD57BBD8A8]
       mov       rdx,rax
       mov       rcx,7FFD57C13BF8
       call      qword ptr [7FFD579169E8]; System.Linq.Enumerable.ToArray[[System.__Canon, System.Private.CoreLib]](System.Collections.Generic.IEnumerable`1<System.__Canon>)
       mov       [rbp-20],rax
       lea       rax,[M02_L02]
       add       rsp,28
       ret
...
; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       ...
       je        near ptr M03_L05
M03_L00:
       mov       rcx,7FFD57C81614
       call      CORINFO_HELP_COUNTPROFILE32
M03_L01:
       mov       rcx,7FFD57C8161C
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,rsi
       mov       rdx,rbx
       mov       rax,7FFD57676208
       mov       [rbp-60],rax
       lea       rax,[M03_L02]
       mov       [rbp-50],rax
       lea       rax,[rbp-70]
...
M03_L05:
       ...
       jne       short M03_L07
M03_L06:
       mov       rcx,7FFD57C81610
       call      CORINFO_HELP_COUNTPROFILE32
       movzx     edi,dil
       jmp       short M03_L04
M03_L07:
       mov       rdx,rsi
       call      qword ptr [7FFD57C64C30]
       test      eax,eax
       je        near ptr M03_L00
       jmp       short M03_L06
M03_L08:
       mov       rcx,7FFD57C81618
       call      CORINFO_HELP_COUNTPROFILE32
...
; System.Runtime.CompilerServices.CastHelpers.StelemRef(System.Object[], IntPtr, System.Object)
       ...
       mov       rcx,rax
       add       rsp,28
       jmp       qword ptr [7FFD57766EE0]; System.Runtime.CompilerServices.CastHelpers.StelemRef_Helper(System.Object ByRef, Void*, System.Object)
M06_L00:
       call      qword ptr [7FFD57BBEFD0]
       int       3
M06_L01:
       mov       rcx,rax
       mov       rdx,r8
       add       rsp,28
       jmp       near ptr 00007FFDB7218FC0
M06_L02:
       xor       ecx,ecx
       mov       [rax],rcx
       add       rsp,28
...
M07_L00:
       ...
       cmovl     edx,ecx
       mov       rcx,rbx
       call      qword ptr [7FFD7EE7AD18]; Precode of System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].set_Capacity(Int32)
       mov       [rbx+10],ebp
       mov       rcx,[rbx+8]
       movsxd    rdx,edi
       mov       r8,rsi
       call      qword ptr [7FFD7EE55008]; Precode of System.Runtime.CompilerServices.CastHelpers.StelemRef(System.Object[], IntPtr, System.Object)
       nop
       add       rsp,28
       pop       rbx
       pop       rbp
