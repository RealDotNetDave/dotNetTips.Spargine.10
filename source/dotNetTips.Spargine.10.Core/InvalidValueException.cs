...
[Serializable]
[Information(nameof(InvalidValueException<>), OptimizationStatus = OptimizationStatus.Completed, Status = Status.Available)]
public sealed class InvalidValueException<TValue> : Exception
{
	...
	public InvalidValueException([DisallowNull] string message) : base(message)
	{
	}
	...
	/// <param name="message">The message that describes the error.</param>
	/// <param name="value">The invalid value that caused the exception.</param>
	public InvalidValueException([DisallowNull] string message, [AllowNull] TValue value) : base(message) => this.Value = value;
	...
	public InvalidValueException([DisallowNull] string message, [AllowNull] Exception innerException) : base(message, innerException)
	{
	}
