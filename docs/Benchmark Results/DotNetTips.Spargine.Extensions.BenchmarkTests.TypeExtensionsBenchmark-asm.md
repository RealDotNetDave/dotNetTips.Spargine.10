...
; DotNetTips.Spargine.Extensions.BenchmarkTests.TypeExtensionsBenchmark.GetTypeMembersWithAttribute()
       ...
       mov       [rsi+18],rdx
       mov       rdx,rsi
       mov       rcx,7FF821A10478
       call      qword ptr [7FF82197EFA0]; System.Linq.Enumerable.<ToArray>g__EnumerableToArray|324_0[[System.__Canon, System.Private.CoreLib]](System.Collections.Generic.IEnumerable`1<System.__Canon>)
       mov       rsi,rax
...
M01_L05:
       mov       rcx,rdi
       mov       rdx,7FF821B056D8
       call      qword ptr [7FF8212CC5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       r11,rax
       jmp       short M01_L04
M01_L06:
       lea       rcx,[rbp-188]
...
M01_L13:
       mov       rcx,rbx
       mov       rdx,7FF821B057C0
       call      qword ptr [7FF8212CC5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       short M01_L09
M01_L14:
       mov       rdx,7FF821ACBC50
       call      qword ptr [7FF821547AF8]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       rdx,rax
       jmp       short M01_L10
M01_L15:
       mov       rcx,[rbx+30]
...
M01_L21:
       call      qword ptr [7FF821467138]
       int       3
M01_L22:
       mov       rcx,rbx
       mov       rdx,7FF821B057F8
       call      qword ptr [7FF8212CC5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       near ptr M01_L16
M01_L23:
       mov       rdx,7FF821B05A60
       call      qword ptr [7FF821547AF8]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       near ptr M01_L17
M01_L24:
       mov       rcx,rbx
       mov       rdx,7FF821B05960
       call      qword ptr [7FF8212CC5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rcx,rax
       jmp       near ptr M01_L18
M01_L25:
       mov       rdx,7FF821B01CA8
       call      qword ptr [7FF8212CC5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
...
M01_L26:
       ...
       mov       r8,r12
       mov       rcx,r14
       call      qword ptr [7FF8212C57A0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       add       r14,r12
       sub       edi,r13d
       mov       r12d,edi
       mov       r13,r14
...
M01_L27:
       ...
       ja        near ptr M01_L40
       mov       rcx,r13
       call      00007FF880E85D60
       cmp       dword ptr [7FF8811EF778],0
       je        near ptr M01_L11
       jmp       near ptr M01_L39
M01_L28:
       call      qword ptr [7FF82175C270]
       int       3
M01_L29:
       mov       rdx,7FF821B05290
       call      qword ptr [7FF821547AF8]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       rsi,rax
       jmp       near ptr M01_L01
M01_L30:
       mov       rcx,rdi
       mov       rdx,7FF821B056C0
       call      qword ptr [7FF8212CC5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       r11,rax
       jmp       near ptr M01_L02
M01_L31:
       mov       ecx,11
       call      qword ptr [7FF821547DF8]
       int       3
M01_L32:
       call      qword ptr [7FF821AAC768]
       int       3
M01_L33:
       mov       rcx,[rbx+30]
       mov       rcx,[rcx]
...
M01_L40:
       mov       rcx,r13
       call      qword ptr [7FF8218CDB90]
       jmp       near ptr M01_L11
M01_L41:
       lea       rcx,[rbp-188]
       call      qword ptr [7FF821AACCA8]
