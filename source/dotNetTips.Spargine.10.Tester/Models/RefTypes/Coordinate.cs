...
public class Coordinate : ICoordinate, IEquatable<Coordinate>, IComparable, IComparable<Coordinate>
{
	...
	public int CompareTo(object? obj) => obj is null
			? 1
			: obj is not Coordinate other ? throw new InvalidCastException(Resources.ObjectIsNotACoordinate) : this.CompareTo(other);
	...
	public bool Equals(Coordinate? other) => ReferenceEquals(this, other) ? true : other is null ? false : this.X == other.X && this.Y == other.Y && this.Z == other.Z;
	...
	[Information(nameof(Equals), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public override bool Equals(object? obj) => ReferenceEquals(this, obj) ? true : obj is null || obj.GetType() != this.GetType() ? false : this.Equals((Coordinate)obj);
