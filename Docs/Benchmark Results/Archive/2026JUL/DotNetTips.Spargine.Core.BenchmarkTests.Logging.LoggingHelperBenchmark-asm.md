...
; DotNetTips.Spargine.Core.BenchmarkTests.Logging.LoggingHelperBenchmark.LogApplicationInformation()
       mov       rcx,[rcx+138]
       jmp       qword ptr [7FF80C52E2B0]; DotNetTips.Spargine.Core.Logging.LoggingHelper.LogApplicationInformation(Microsoft.Extensions.Logging.ILogger)
...
M01_L06:
       ...
       mov       rsi,rax
       call      qword ptr [7FF80C5CD068]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF80C49E448]
       mov       rcx,rsi
...
M01_L08:
       ...
       mov       rcx,r14
       mov       edx,2
       call      qword ptr [7FF80C5CC438]
       test      eax,eax
       je        short M01_L09
       mov       rdx,[r14]
       lea       r8,[rsp+58]
       mov       ecx,2
       call      qword ptr [7FF80C5CC450]
       test      eax,eax
...
M01_L13:
       ...
       mov       rcx,[rcx]
       cmp       [rcx],ecx
       call      qword ptr [7FF80C18FF78]; System.Lazy`1[[System.__Canon, System.Private.CoreLib]].get_Value()
       mov       rsi,rax
       lea       rcx,[rsp+178]
       mov       edx,4
       mov       r8d,3
       call      qword ptr [7FF80BEFC270]; System.Runtime.CompilerServices.DefaultInterpolatedStringHandler..ctor(Int32, Int32)
       lea       rcx,[rsp+178]
       mov       rdx,221501A0A40
       call      qword ptr [7FF80C18E370]; System.Runtime.CompilerServices.DefaultInterpolatedStringHandler.AppendFormatted(System.String)
       mov       ecx,[rsp+188]
       cmp       ecx,[rsp+198]
       ja        near ptr M01_L51
       mov       rdx,[rsp+190]
...
M01_L17:
       ...
       call      qword ptr [7FF80C18E370]; System.Runtime.CompilerServices.DefaultInterpolatedStringHandler.AppendFormatted(System.String)
       lea       rcx,[rsp+178]
       call      qword ptr [7FF80BEFC2A0]; System.Runtime.CompilerServices.DefaultInterpolatedStringHandler.ToStringAndClear()
       mov       rdi,rax
       mov       rcx,rbx
...
; DotNetTips.Spargine.Core.BenchmarkTests.Logging.LoggingHelperBenchmark.LogComputerInformation()
       mov       rcx,[rcx+138]
       jmp       qword ptr [7FF80C53DD40]; DotNetTips.Spargine.Core.Logging.LoggingHelper.LogComputerInformation(Microsoft.Extensions.Logging.ILogger)
; Total bytes of code 13
```
```assembly
...
M01_L05:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FF80C5D63B8]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF80C5D54B8]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
M01_L06:
...
M01_L07:
       ...
       mov       rcx,r14
       mov       edx,2
       call      qword ptr [7FF80C5D53F8]
       test      eax,eax
       je        short M01_L08
       mov       rdx,[r14]
       lea       r8,[rsp+28]
       mov       ecx,2
       call      qword ptr [7FF80C5D5410]
       test      eax,eax
...
M01_L12:
       ...
       mov       rsi,rax
       mov       rcx,rsi
       call      qword ptr [7FF80C53DD88]
       mov       r8,[rsi+8]
       mov       rcx,rbx
       mov       rdx,31C57A80A40
       mov       r9,31C57A80A78
       call      qword ptr [7FF80C53DDB8]
       mov       r8,[rsi+10]
       mov       rcx,rbx
       mov       rdx,31C57A80AA8
       mov       r9,31C57A80A78
       ...
       cmp       [rdi],dil
       mov       rcx,rdi
       call      qword ptr [7FF80C19E568]; System.Version.get_DefaultFormatFieldCount()
       mov       edx,eax
       mov       rcx,rdi
       call      qword ptr [7FF80C284288]; System.Version.ToString(Int32)
       mov       r8,rax
       mov       rcx,rbx
       mov       rdx,31C57A80C58
       mov       r9,31C57A80A78
       ...
       mov       r9,31C57A80A78
       call      qword ptr [7FF80C53DDB8]
       call      00007FF80BEF8C30
       mov       rcx,rax
       call      qword ptr [7FF80C4267F0]; System.TimeSpan.FromMilliseconds(Int64)
       mov       rcx,rax
       call      qword ptr [7FF80C5D63E8]
       mov       r8,rax
       mov       rcx,rbx
...
; DotNetTips.Spargine.Core.BenchmarkTests.Logging.LoggingHelperBenchmark.RetrieveAllExceptionMessages()
       ...
       mov       rcx,rdi
       call      qword ptr [7FF80C54DF20]; DotNetTips.Spargine.Core.Logging.LoggingHelper.RetrieveAllExceptions(System.Exception)
       mov       rsi,rax
       mov       rcx,1CF14C001D8
       mov       rdi,[rcx]
       test      rdi,rdi
...
M00_L17:
       ...
       mov       r8,7FF80C62A2E8
       call      qword ptr [7FF80BF15920]; System.Runtime.CompilerServices.VirtualDispatchHelpers.VirtualFunctionPointer(System.Object, IntPtr, IntPtr)
       mov       rcx,rbp
       mov       rdx,rdi
       call      rax
       mov       r15,rax
...
M00_L21:
       ...
       mov       rdx,rsi
       mov       r8,rdi
       call      qword ptr [7FF80C5E77B0]
       jmp       near ptr M00_L01
M00_L22:
       mov       ecx,11
       call      qword ptr [7FF80BF1F948]
       int       3
M00_L23:
       mov       r11,7FF80BE60A40
       call      qword ptr [r11]
       mov       edi,eax
       jmp       near ptr M00_L02
M00_L24:
       mov       r11,7FF80BE60A38
       call      qword ptr [r11]
       mov       edi,eax
       jmp       near ptr M00_L02
M00_L25:
...
M01_L03:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FF80C5E77C8]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF80C5E6910]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
...
M03_L05:
       pop       rbx
       pop       rsi
       jmp       qword ptr [7FF80BF1FAB0]; System.Runtime.CompilerServices.CastHelpers.IsInstanceOfAny_NoCacheLookup(Void*, System.Object)
...
M05_L04:
       ...
       pop       rdi
       pop       r14
       jmp       qword ptr [7FF80C4BE580]
M05_L05:
       mov       rcx,7FF80C5D4EAC
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M05_L11
M05_L06:
       mov       rcx,7FF80C5D4EB0
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M05_L11
M05_L07:
       mov       rcx,7FF80C5D4EB4
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M05_L11
M05_L08:
       mov       rcx,7FF80C5D4EB8
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M05_L11
M05_L09:
       mov       rcx,7FF80C5D4EBC
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M05_L11
M05_L10:
       xor       esi,esi
       ...
       jmp       short M05_L12
M05_L11:
       mov       rcx,7FF80C5D4EC4
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,rsi
       xor       edx,edx
       call      qword ptr [7FF80C54FDB0]; System.Array.GetLowerBound(Int32)
       mov       ebp,eax
M05_L12:
       test      rbx,rbx
       jne       short M05_L13
...
M05_L14:
       ...
       mov       r8,rbx
       mov       r9d,r14d
       call      qword ptr [7FF80C54FDC8]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
...
M06_L03:
       mov       rcx,rax
       cmp       [rcx],ecx
       call      qword ptr [7FF80C5E6238]
       mov       rdx,rax
       mov       rcx,rsi
       add       rsp,28
       pop       rbx
       pop       rsi
       jmp       qword ptr [7FF80C5E6250]
...
M08_L02:
       ...
       pop       r14
       pop       r15
       jmp       qword ptr [7FF80C1AC858]; System.Runtime.CompilerServices.VirtualDispatchHelpers.VirtualFunctionPointerSlow(System.Object, IntPtr, IntPtr)
