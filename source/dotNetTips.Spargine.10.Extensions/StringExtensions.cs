...
public static class StringExtensions
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[Information(nameof(FormatCurrentCulture), "Copilot Agent", "07-08-2026", UnitTestStatus = UnitTestStatus.None, OptimizationStatus = OptimizationStatus.Optimize, BenchmarkStatus = BenchmarkStatus.Benchmark, Status = Status.New)]
	...
	/// <returns>The formatted string.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[Information(nameof(FormatInvariant), "Copilot Agent", "07-08-2026", UnitTestStatus = UnitTestStatus.None, OptimizationStatus = OptimizationStatus.Optimize, BenchmarkStatus = BenchmarkStatus.Benchmark, Status = Status.New)]
	...
	/// </remarks>
	[Information(nameof(FromDeflateStringAsync), "David McCarter", "9/12/2022", UnitTestStatus = UnitTestStatus.Completed, OptimizationStatus = OptimizationStatus.Completed, BenchmarkStatus = BenchmarkStatus.Completed, Status = Status.Available)]
	...
	/// </remarks>
	[Information(nameof(FromZLibStringAsync), "David McCarter", "9/12/2022", UnitTestStatus = UnitTestStatus.Completed, OptimizationStatus = OptimizationStatus.Completed, BenchmarkStatus = BenchmarkStatus.Completed, Status = Status.Available)]
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	[Information(nameof(JoinFormatted), "Copilot Agent", "07-08-2026", UnitTestStatus = UnitTestStatus.None, OptimizationStatus = OptimizationStatus.Optimize, BenchmarkStatus = BenchmarkStatus.Benchmark, Status = Status.New)]
	...
	/// </summary>
	private static void AppendArgsToBuilder(StringBuilder sb, ReadOnlyCollection<string> args, string delimiter, bool addLineFeed)
	{
	...
	/// <summary>
	/// Builds the concatenated string from <paramref name="input"/> and <paramref name="args"/> using a pooled
	/// <see cref="StringBuilder"/>, pre-sized to avoid reallocations.
	/// </summary>
	private static string BuildConcatenatedString(string input, ReadOnlyCollection<string> args, string delimiter, bool addLineFeed)
	{
		...
		try
		{
			...
			AppendArgsToBuilder(pooledSb, args, delimiter, addLineFeed);
