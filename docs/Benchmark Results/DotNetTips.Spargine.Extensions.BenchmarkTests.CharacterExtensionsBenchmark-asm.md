...
M00_L06:
       mov       ecx,2
       call      qword ptr [7FFB6D94F948]; System.Runtime.CompilerServices.StaticsHelpers.GetOptimizedGCThreadStaticBase(Int32)
       jmp       near ptr M00_L00
M00_L07:
       call      qword ptr [7FFB6D32D4B8]; System.Globalization.CultureInfo.InitializeUserDefaultCulture()
       mov       rsi,rax
       jmp       short M00_L01
M00_L08:
       ...
       mov       rdx,[rsi+30]
       mov       rcx,rdi
       call      qword ptr [7FFB6D944F48]; System.Globalization.TextInfo..ctor(System.Globalization.CultureData)
...
M00_L10:
       mov       rcx,rdi
       call      qword ptr [7FFB6D9473C0]; System.Globalization.TextInfo.PopulateIsAsciiCasingSameAsInvariant()
       jmp       near ptr M00_L04
M00_L11:
       mov       rcx,rdi
       mov       edx,41
       xor       r8d,r8d
       call      qword ptr [7FFB6D94F9C0]
       mov       esi,eax
...
; System.Globalization.TextInfo.PopulateIsAsciiCasingSameAsInvariant()
       ...
       mov       rbx,rcx
       mov       rcx,[rbx+18]
       call      qword ptr [7FFB6E92F9E0]; Precode of System.Globalization.CultureInfo.GetCultureInfo(System.String)
       mov       rcx,rax
       ...
       mov       r9d,1
       cmp       [rcx],ecx
       call      qword ptr [7FFB6E92F230]; Precode of System.Globalization.CompareInfo.Compare(System.String, System.String, System.Globalization.CompareOptions)
       mov       ecx,2
       mov       edx,1
       test      eax,eax
       cmovne    ecx,edx
...
M00_L07:
       mov       ecx,2
       call      qword ptr [7FFB6D9D6178]; System.Runtime.CompilerServices.StaticsHelpers.GetOptimizedGCThreadStaticBase(Int32)
       jmp       near ptr M00_L00
M00_L08:
       call      qword ptr [7FFB6D31D4B8]; System.Globalization.CultureInfo.InitializeUserDefaultCulture()
       mov       rsi,rax
       jmp       short M00_L01
M00_L09:
       mov       rcx,offset MT_System.Globalization.TextInfo
       ...
       mov       rdx,[rsi+30]
       mov       rcx,rdi
       call      qword ptr [7FFB6D96CC00]; System.Globalization.TextInfo..ctor(System.Globalization.CultureData)
       movzx     ecx,byte ptr [rsi+60]
       mov       [rdi+30],cl
       lea       rcx,[rsi+10]
       mov       rdx,rdi
...
M00_L11:
       mov       rcx,rdi
       call      qword ptr [7FFB6D96F078]; System.Globalization.TextInfo.PopulateIsAsciiCasingSameAsInvariant()
       jmp       near ptr M00_L04
