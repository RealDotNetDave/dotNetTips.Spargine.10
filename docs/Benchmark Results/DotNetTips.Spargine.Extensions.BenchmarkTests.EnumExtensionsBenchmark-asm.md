...
M00_L02:
       ...
       mov       rcx,r10
       mov       rdx,rsi
       call      qword ptr [7FFCFC7160A0]; System.Enum.Equals(System.Object)
M00_L03:
       test      eax,eax
       je        near ptr M00_L12
M00_L04:
...
M00_L18:
       ...
       mov       r8,rsi
       mov       rcx,r14
       call      qword ptr [7FFCFCC8C270]; System.Collections.Concurrent.ConcurrentDictionary`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].TryAddInternal(Tables<System.__Canon,System.__Canon>, System.__Canon, System.Nullable`1<Int32>, System.__Canon, Boolean, Boolean, System.__Canon ByRef)
...
M01_L00:
       ...
       lea       rsi,[rbx+8]
       lea       rdi,[rdx+8]
       call      00007FFD5C3D9050
       add       eax,0FFFFFFFE
       cmp       eax,17
       ja        short M01_L03
       lea       rcx,[7FFCFC89E4A0]
       mov       ecx,[rcx+rax*4]
       lea       rdx,[M01_L00]
       add       rcx,rdx
       jmp       rcx
...
M02_L00:
       mov       rcx,[rbp-8]
       mov       rdx,[rbp+18]
       call      qword ptr [7FFCFCF1D8A8]; System.Enum.GetName(System.Type, System.Object)
       mov       [rbp-10],rax
; 			if (name == null)
; 			^^^^^^^^^^^^^^^^^
...
M02_L01:
       ...
       mov       rdx,[rbp-10]
       cmp       [rcx],ecx
       call      qword ptr [7FFCFCF1D8C0]; System.Type.GetField(System.String)
       mov       [rbp-18],rax
; 			if (field == null)
; 			^^^^^^^^^^^^^^^^^^
       mov       rcx,[rbp-18]
       xor       edx,edx
       call      qword ptr [7FFCFCF1D8D8]; System.Reflection.FieldInfo.op_Equality(System.Reflection.FieldInfo, System.Reflection.FieldInfo)
       test      eax,eax
       je        short M02_L02
; 				return name;
; 				^^^^^^^^^^^^
...
M02_L02:
       mov       rdx,[rbp-18]
       mov       rcx,7FFCFCFB62C8
       xor       r8d,r8d
       call      qword ptr [7FFCFCE15968]; System.Reflection.CustomAttributeExtensions.GetCustomAttribute[[System.__Canon, System.Private.CoreLib]](System.Reflection.MemberInfo, Boolean)
       mov       [rbp-20],rax
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,rax
       call      qword ptr [7FFCFCB9E0E8]; System.String.IsNullOrEmpty(System.String)
       test      eax,eax
       jne       short M02_L03
...
M04_L01:
       ...
       lea       rdx,[rbp-48]
       call      qword ptr [7FFD5CC90080]; Precode of System.Threading.Monitor.Enter(System.Object, Boolean ByRef)
M04_L02:
       mov       rcx,[rbp+18]
       mov       r8,[rbp+10]
       cmp       rcx,[r8+8]
...
M04_L03:
       mov       rcx,[r8]
       call      qword ptr [7FFD5CC8F740]
       mov       rcx,rax
       call      qword ptr [7FFD5CC8F2C0]; CORINFO_HELP_NEWFAST
       mov       r15,rax
       mov       r13,[rbx]
       lea       rcx,[r15+8]
       mov       rdx,[rbp+20]
       call      qword ptr [7FFD5CC8F298]; CORINFO_HELP_ASSIGN_REF
       lea       rcx,[r15+10]
       mov       rdx,[rbp+30]
       call      qword ptr [7FFD5CC8F298]; CORINFO_HELP_ASSIGN_REF
       lea       rcx,[r15+18]
...
M04_L05:
       ...
       jne       short M04_L06
       mov       rcx,[r8]
       call      qword ptr [7FFD5CC8F6E8]
       mov       rcx,rax
       call      qword ptr [7FFD5CC8FDF0]
       mov       rdx,[r15+8]
       mov       rcx,[rbp-58]
       mov       r11,rax
       mov       r8,[rbp+20]
...
M04_L07:
       ...
       mov       rcx,[rbp+48]
       mov       rdx,[rbp+30]
       call      qword ptr [7FFD5CC8F2A0]; CORINFO_HELP_CHECKED_ASSIGN_REF
M04_L08:
       xor       ecx,ecx
       mov       [rbp-4C],ecx
...
M04_L12:
       call      qword ptr [7FFD5CC8F290]
       int       3
M04_L13:
       call      qword ptr [7FFD5CC8F288]
       int       3
M04_L14:
       mov       rdx,[r15+10]
       mov       rcx,[rbp+48]
...
M04_L20:
       ...
       call      qword ptr [7FFD5CC90088]; Precode of System.Threading.Monitor.Exit(System.Object)
       mov       r8,[rbp+10]
M04_L21:
       mov       ecx,esi
       or        ecx,edi
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.EnumExtensionsBenchmark.GetItems()
       ...
       mov       [rax+8],ecx
       mov       rcx,rax
       call      qword ptr [7FFCFCF3EDF0]; DotNetTips.Spargine.Extensions.EnumExtensions.GetItems(System.Enum)
       mov       [rsp+28],rax
       mov       rbx,[rbx+60]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       [rbp-78],rcx
       mov       rcx,rbx
       call      qword ptr [7FFCFCA961C0]; System.Object.GetType()
       mov       rbx,rax
       mov       [rbp-0C8],rbx
       mov       rcx,[rbx+18]
       test      cl,2
...
M01_L00:
       ...
       je        near ptr M01_L73
       mov       rcx,rbx
       call      qword ptr [7FFCFCF3EEC8]; System.Enum.GetValuesAsUnderlyingTypeNoCopy(System.RuntimeType)
       mov       rdi,rax
       mov       [rbp-0D0],rdi
       mov       ecx,[rdi+8]
       test      ecx,ecx
...
M01_L18:
       ...
       mov       rcx,rdi
       mov       rdx,r12
       call      qword ptr [7FFCFCF3EFA0]; System.Array.CanAssignArrayType(System.Array, System.Array)
       test      eax,eax
...
M01_L21:
       ...
       je        near ptr M01_L73
       mov       rcx,rbx
       call      qword ptr [7FFCFCF3CFF0]; System.Enum.GetNamesNoCopy(System.RuntimeType)
       test      rax,rax
       je        near ptr M01_L33
       lea       rbx,[rax+10]
       mov       esi,[rax+8]
...
M01_L41:
       ...
       call      qword ptr [7FFCFCF3F060]; System.Enum.GetValue()
       test      rax,rax
       je        short M01_L45
       mov       rdx,rax
...
M01_L58:
       ...
       call      qword ptr [7FFCFC7CF210]
       mov       rcx,rax
       call      qword ptr [7FFCFCFE5D10]
       int       3
M01_L59:
       mov       rcx,offset MT_System.RankException
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFCFCFE7C00]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FFCFCFE7C18]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M01_L60:
...
M01_L71:
       ...
       mov       rcx,rdx
       mov       rdx,r10
       call      qword ptr [7FFCFC7C66E8]; System.Buffer.MemmoveInternal(Byte ByRef, Byte ByRef, UIntPtr)
       jmp       near ptr M01_L20
M01_L72:
       mov       [rsp+20],ebx
       mov       [rsp+28],eax
       ...
       mov       r8,r12
       mov       r9d,r13d
       call      qword ptr [7FFCFCFE7C90]
       jmp       near ptr M01_L20
M01_L73:
       call      qword ptr [7FFCFCFE7600]
       int       3
M01_L74:
...
M01_L80:
       mov       rcx,r12
       call      qword ptr [7FFCFCF3FC30]; System.RuntimeTypeHandle.<InternalAllocNoChecks>g__InternalAllocNoChecksWorker|37_0(System.Runtime.CompilerServices.MethodTable*)
...
M01_L90:
       mov       rcx,r12
       mov       rdx,r13
       call      qword ptr [7FFCFC7C5878]; System.Runtime.CompilerServices.CastHelpers.Box_Nullable(System.Runtime.CompilerServices.MethodTable*, Byte ByRef)
       mov       rdx,rax
       mov       r13,rdx
...
M01_L95:
       ...
       lea       rdx,[rbp-0C0]
       mov       rcx,rbx
       call      qword ptr [7FFCFCFE75B8]
       jmp       near ptr M01_L47
M01_L96:
       mov       ecx,3A
       call      qword ptr [7FFCFCFE74B0]
       int       3
M01_L97:
       mov       ecx,43
       call      qword ptr [7FFCFCF35F08]
       int       3
M01_L98:
       mov       edx,4
...
M01_L105:
       ...
       xor       edx,edx
       mov       [rsp+28],edx
       call      qword ptr [7FFCFCF3EF88]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M01_L52
       int       3
M01_L106:
       call      CORINFO_HELP_RNGCHKFAIL
