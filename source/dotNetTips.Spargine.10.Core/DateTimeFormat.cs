...
public class DateTimeFormat : Enumeration
{
	...
	/// <summary>
	/// ISO 8601 date pattern. Example: 2025-12-21
	/// </summary>
	public static readonly DateTimeFormat IsoDate = new(17, "yyyy-MM-dd");

	/// <summary>
	/// ISO 8601 date/time pattern. Example: 2025-12-21T15:16:12
	/// </summary>
	public static readonly DateTimeFormat IsoDateTime = new(18, "yyyy-MM-ddTHH:mm:ss");
