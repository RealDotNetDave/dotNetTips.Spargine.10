...
M00_L02:
       ...
       mov       rcx,r10
       mov       rdx,rsi
       call      qword ptr [7FFF782460A0]; System.Enum.Equals(System.Object)
M00_L03:
       test      eax,eax
       je        near ptr M00_L12
M00_L04:
...
M00_L18:
       ...
       mov       r8,rsi
       mov       rcx,r14
       call      qword ptr [7FFF7868D3B0]; System.Collections.Concurrent.ConcurrentDictionary`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].TryAddInternal(Tables<System.__Canon,System.__Canon>, System.__Canon, System.Nullable`1<Int32>, System.__Canon, Boolean, Boolean, System.__Canon ByRef)
...
M01_L00:
       ...
       lea       rsi,[rbx+8]
       lea       rdi,[rdx+8]
       call      00007FFFD7F4F240
       add       eax,0FFFFFFFE
       cmp       eax,17
       ja        short M01_L03
       lea       rcx,[7FFF789F53D0]
       mov       ecx,[rcx+rax*4]
       lea       rdx,[M01_L00]
       add       rcx,rdx
       jmp       rcx
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^
       mov       rcx,[rbp+18]
       cmp       [rcx],ecx
       call      qword ptr [7FFF784D61D8]; System.Object.GetType()
       mov       [rbp-8],rax
; 			if (!type.IsEnum)
; 			^^^^^^^^^^^^^^^^^
       mov       rcx,[rbp-8]
...
M02_L00:
       mov       rcx,[rbp-8]
       mov       rdx,[rbp+18]
       call      qword ptr [7FFF7892DD70]; System.Enum.GetName(System.Type, System.Object)
       mov       [rbp-10],rax
; 			if (name == null)
; 			^^^^^^^^^^^^^^^^^
...
M02_L01:
       ...
       mov       rdx,[rbp-10]
       cmp       [rcx],ecx
       call      qword ptr [7FFF7892DD88]; System.Type.GetField(System.String)
       mov       [rbp-18],rax
; 			if (field == null)
; 			^^^^^^^^^^^^^^^^^^
       mov       rcx,[rbp-18]
       xor       edx,edx
       call      qword ptr [7FFF7892DDA0]; System.Reflection.FieldInfo.op_Equality(System.Reflection.FieldInfo, System.Reflection.FieldInfo)
       test      eax,eax
       je        short M02_L02
; 				return name;
; 				^^^^^^^^^^^^
...
M02_L02:
       mov       rdx,[rbp-18]
       mov       rcx,7FFF7896FD38
       xor       r8d,r8d
       call      qword ptr [7FFF78827618]; System.Reflection.CustomAttributeExtensions.GetCustomAttribute[[System.__Canon, System.Private.CoreLib]](System.Reflection.MemberInfo, Boolean)
       mov       [rbp-20],rax
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,rax
       call      qword ptr [7FFF7859F120]; System.String.IsNullOrEmpty(System.String)
       test      eax,eax
       jne       short M02_L03
...
M04_L06:
       ...
       lea       rdx,[rbp-50]
       call      qword ptr [7FFFFD67AB78]; Precode of System.Threading.Monitor.Enter(System.Object, Boolean ByRef)
M04_L07:
       mov       rcx,[rbp+18]
       cmp       rcx,[rbx+8]
...
M04_L08:
       ...
       jne       short M04_L09
       mov       rcx,[rbx]
       call      qword ptr [7FFFFD67A3D8]
       mov       rcx,rax
       call      qword ptr [7FFFFD67A910]
       mov       rdx,[r13+8]
       mov       rcx,[rbp-60]
       mov       r11,rax
       mov       r8,[rbp+20]
...
M04_L10:
       mov       rcx,[rbx]
       call      qword ptr [7FFFFD67A430]
       mov       rcx,rax
       call      qword ptr [7FFFFD67A280]; CORINFO_HELP_NEWFAST
       mov       r13,rax
       mov       r12,[rsi]
       lea       rcx,[r13+8]
       mov       rdx,[rbp+20]
       call      qword ptr [7FFFFD67A258]; CORINFO_HELP_ASSIGN_REF
       lea       rcx,[r13+10]
       mov       rdx,[rbp+30]
       call      qword ptr [7FFFFD67A258]; CORINFO_HELP_ASSIGN_REF
       lea       rcx,[r13+18]
...
M04_L12:
       ...
       mov       rdx,[r13+10]
       mov       rcx,[rbp+48]
       call      qword ptr [7FFFFD67A260]; CORINFO_HELP_CHECKED_ASSIGN_REF
       jmp       short M04_L14
M04_L13:
       lea       rcx,[r13+10]
       mov       rdx,[rbp+30]
...
M04_L18:
       call      qword ptr [7FFFFD67A250]
       int       3
M04_L19:
       call      qword ptr [7FFFFD67A248]
       int       3
M04_L20:
       ...
       call      qword ptr [7FFFFD67AB80]; Precode of System.Threading.Monitor.Exit(System.Object)
M04_L21:
       mov       ecx,edi
       or        ecx,r14d
       je        short M04_L22
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.EnumExtensionsBenchmark.GetItems()
       ...
       mov       [rax+8],ecx
       mov       rcx,rax
       call      qword ptr [7FFF7891D5C0]; DotNetTips.Spargine.Extensions.EnumExtensions.GetItems(System.Enum)
       mov       [rsp+28],rax
       mov       rbx,[rbx+60]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L00:
       ...
       je        near ptr M01_L73
       mov       rcx,rbx
       call      qword ptr [7FFF7891D698]; System.Enum.GetValuesAsUnderlyingTypeNoCopy(System.RuntimeType)
       mov       rdi,rax
       mov       [rbp-0D0],rdi
       mov       ecx,[rdi+8]
       test      ecx,ecx
...
M01_L18:
       ...
       mov       rcx,rdi
       mov       rdx,r12
       call      qword ptr [7FFF7891D770]; System.Array.CanAssignArrayType(System.Array, System.Array)
       test      eax,eax
...
M01_L21:
       ...
       je        near ptr M01_L73
       mov       rcx,rbx
       call      qword ptr [7FFF789177B0]; System.Enum.GetNamesNoCopy(System.RuntimeType)
       test      rax,rax
       je        near ptr M01_L33
       lea       rbx,[rax+10]
       mov       esi,[rax+8]
...
M01_L41:
       ...
       call      qword ptr [7FFF7891D830]; System.Enum.GetValue()
       test      rax,rax
       je        short M01_L45
       mov       rdx,rax
...
M01_L56:
       ...
       je        short M01_L57
       call      qword ptr [7FFF782F57A0]; System.Buffer.BulkMoveWithWriteBarrier(Byte ByRef, Byte ByRef, UIntPtr)
       jmp       near ptr M01_L20
M01_L57:
...
M01_L58:
       ...
       call      qword ptr [7FFF782FF228]
       mov       rcx,rax
       call      qword ptr [7FFF789A4138]
       int       3
M01_L59:
       mov       rcx,offset MT_System.RankException
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FFF789A5830]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FFF789A5848]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M01_L60:
...
M01_L71:
       ...
       mov       rcx,rdx
       mov       rdx,r10
       call      qword ptr [7FFF782F66E8]; System.Buffer.MemmoveInternal(Byte ByRef, Byte ByRef, UIntPtr)
       jmp       near ptr M01_L20
M01_L72:
       mov       [rsp+20],ebx
       mov       [rsp+28],eax
       ...
       mov       r8,r12
       mov       r9d,r13d
       call      qword ptr [7FFF789A58C0]
       jmp       near ptr M01_L20
M01_L73:
       call      qword ptr [7FFF789A52D8]
       int       3
M01_L74:
...
M01_L80:
       mov       rcx,r12
       call      qword ptr [7FFF7891E3D0]; System.RuntimeTypeHandle.<InternalAllocNoChecks>g__InternalAllocNoChecksWorker|37_0(System.Runtime.CompilerServices.MethodTable*)
...
M01_L90:
       mov       rcx,r12
       mov       rdx,r13
       call      qword ptr [7FFF782F5878]; System.Runtime.CompilerServices.CastHelpers.Box_Nullable(System.Runtime.CompilerServices.MethodTable*, Byte ByRef)
       mov       rdx,rax
       mov       r13,rdx
...
M01_L95:
       ...
       lea       rdx,[rbp-0C0]
       mov       rcx,rbx
       call      qword ptr [7FFF789A5290]
       jmp       near ptr M01_L47
M01_L96:
       mov       ecx,3A
       call      qword ptr [7FFF789A5188]
       int       3
M01_L97:
       mov       ecx,43
       call      qword ptr [7FFF789159C8]
       int       3
M01_L98:
       mov       edx,4
...
M01_L105:
       ...
       xor       edx,edx
       mov       [rsp+28],edx
       call      qword ptr [7FFF7891D758]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M01_L52
M01_L106:
       call      CORINFO_HELP_RNGCHKFAIL
       int       3
