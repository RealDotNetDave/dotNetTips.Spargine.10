...
// ***********************************************************************
// <copyright file="MemoryExtensionsTests.cs" company="dotNetTips.com - McCarter Consulting">
...
public class MemoryExtensionsTests
{
	...
	{
		Memory<string> memory1 = new[] { "Alpha", "Beta" };
		Memory<string> memory2 = new[] { "ALPHA", "BETA" };
	...
	{
		Memory<int> memory1 = new[] { 1, 2, 3 };
		Memory<int> memory2 = new[] { 1, 2, 4 };
	...
	{
		var array = RandomData.GenerateByteArray(10);
		Memory<byte> memory = array.AsMemory(1, 3);
	...
	{
		var array = RandomData.GenerateByteArray(10);
		Memory<byte> memory = array.AsMemory(2, 5);
