...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetInstances()
       ...
       mov       [rbp-58],rax
       mov       rbx,rcx
       call      qword ptr [7FF8EFA8D770]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rsi,rax
...
M00_L05:
       ...
       call      qword ptr [7FF8EF5A0218]; System.Reflection.Assembly.GetTypes()
M00_L06:
       mov       rcx,29CC6827000
       mov       [rsi+20],rcx
       lea       rcx,[rsi+28]
...
M00_L20:
       ...
       mov       rdx,rax
       mov       r8d,1
       call      qword ptr [7FF8EF46EDA8]; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       mov       r10d,eax
       jmp       short M00_L17
M00_L21:
       mov       r10d,1
...
M00_L22:
       ...
       jne       short M00_L24
       mov       rcx,r13
       call      qword ptr [7FF8EF46D398]; System.RuntimeType.get_IsActualInterface()
       test      eax,eax
       jne       near ptr M00_L28
       mov       rcx,r13
       call      00007FF94F0928C0
       test      eax,eax
       je        near ptr M00_L02
       mov       rcx,r13
       call      qword ptr [7FF8EF3AA400]
       mov       r13,rax
       xor       r12d,r12d
...
M00_L30:
       mov       rcx,rdi
       call      qword ptr [7FF8EF467C30]; System.RuntimeType.InitializeCache()
M00_L31:
       mov       rdx,[rax+80]
       test      rdx,rdx
       je        near ptr M00_L37
...
M00_L37:
       ...
       call      qword ptr [7FF8EF46C4F8]; System.RuntimeType+IGenericCacheEntry`1[[System.__Canon, System.Private.CoreLib]].CreateAndCache(System.RuntimeType)
       mov       r14,rax
       jmp       near ptr M00_L33
M00_L38:
       mov       rcx,[rbp-50]
       mov       r11,7FF8EF3B09D8
       call      qword ptr [r11]
       mov       rdi,rax
       jmp       short M00_L35
M00_L39:
...
M00_L51:
       mov       rcx,rax
       mov       r11,7FF8EF3B09D0
       call      qword ptr [r11]
       test      eax,eax
       jne       near ptr M00_L38
       jmp       near ptr M00_L57
M00_L52:
       call      qword ptr [7FF8EF9FF150]
       mov       ecx,49
       mov       rdx,7FF8EF83C218
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FF8EFB361D8]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF8EFB353F8]
       mov       rcx,rsi
...
M00_L54:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF8EFB34E28]
       mov       rcx,rax
       mov       rdx,rdi
       call      qword ptr [7FF8EFB34E40]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF8EFB34E58]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M00_L55:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF8EFB34E70]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF8EF6877C8]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M00_L56:
...
M00_L59:
       ...
       mov       rcx,rsi
       xor       edx,edx
       call      qword ptr [7FF8EFA8D788]; DotNetTips.Spargine.Extensions.AssemblyExtensions+<GetInstances>d__3`1[[System.__Canon, System.Private.CoreLib]]..ctor(Int32)
       jmp       near ptr M00_L00
M00_L60:
       mov       rcx,rax
       mov       r11,7FF8EF3B09E0
       call      qword ptr [r11]
       jmp       short M00_L58
       sub       rsp,28
       mov       rdx,rcx
...
M02_L13:
       ...
       mov       r9d,ebx
       xor       edx,edx
       call      qword ptr [7FF8EF97D650]; System.Array.Copy(System.Array, Int32, System.Array, Int32, Int32)
       add       ebx,r15d
       inc       edi
M02_L14:
       cmp       [r14+8],edi
...
; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       ...
       je        near ptr M03_L05
M03_L00:
       mov       rcx,7FF8EFB517DC
       call      CORINFO_HELP_COUNTPROFILE32
M03_L01:
       mov       rcx,7FF8EFB517E4
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,rsi
       mov       rdx,rbx
       mov       rax,7FF8EF546208
       mov       [rbp-60],rax
       lea       rax,[M03_L02]
       mov       [rbp-50],rax
       lea       rax,[rbp-70]
...
M03_L05:
       ...
       jne       short M03_L07
M03_L06:
       mov       rcx,7FF8EFB517D8
       call      CORINFO_HELP_COUNTPROFILE32
       movzx     edi,dil
       jmp       short M03_L04
M03_L07:
       mov       rdx,rsi
       call      qword ptr [7FF8EFB34B10]
       test      eax,eax
       je        near ptr M03_L00
       jmp       short M03_L06
M03_L08:
       mov       rcx,7FF8EFB517E0
       call      CORINFO_HELP_COUNTPROFILE32
...
M06_L08:
       ...
       lea       rcx,[rbp-40]
       mov       edx,1
       call      qword ptr [7FF8EFB36340]; System.RuntimeTypeHandle.GetGCHandle(System.Runtime.InteropServices.GCHandleType)
       mov       rdx,rax
       lea       rcx,[rbx+10]
       xor       eax,eax
...
M06_L10:
       mov       [rbp+10],rbx
       mov       rcx,rbx
       call      qword ptr [7FF8EF467C78]; System.RuntimeTypeHandle.<GetModule>g__GetModuleWorker|48_0(System.RuntimeType)
       mov       r14,rax
       mov       rbx,[rbp+10]
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetTypes()
       ...
       mov       [rbp-40],rax
       mov       rbx,rcx
       call      qword ptr [7FF8EFA7D638]; System.Reflection.Assembly.GetExecutingAssembly()
       test      rax,rax
       je        near ptr M00_L25
       mov       rcx,offset MT_System.Reflection.RuntimeAssembly
       cmp       [rax],rcx
       ...
       mov       rcx,rax
       call      qword ptr [7FF8EF590218]; System.Reflection.Assembly.GetTypes()
       mov       rsi,rax
M00_L00:
...
M00_L04:
       ...
       mov       r8d,1
       call      qword ptr [7FF8EF45EDA8]; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       mov       r12d,eax
...
M00_L06:
       ...
       jne       short M00_L08
       mov       rcx,240C5667000
       call      qword ptr [7FF8EF45D398]; System.RuntimeType.get_IsActualInterface()
       test      eax,eax
...
M00_L25:
       call      qword ptr [7FF8EF9EF120]
       mov       ecx,49
       mov       rdx,7FF8EF82C218
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FF8EFB25E90]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF8EFB251D0]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
M00_L26:
...
M00_L38:
       ...
       xor       edx,edx
       mov       [rsp+28],edx
       call      qword ptr [7FF8EFA7F6F0]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M00_L22
M00_L39:
...
M02_L13:
       ...
       mov       r9d,ebx
       xor       edx,edx
       call      qword ptr [7FF8EF96D650]; System.Array.Copy(System.Array, Int32, System.Array, Int32, Int32)
       add       ebx,r15d
       inc       edi
M02_L14:
       cmp       [r14+8],edi
...
; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       ...
       je        near ptr M03_L05
M03_L00:
       mov       rcx,7FF8EFB1F9EC
       call      CORINFO_HELP_COUNTPROFILE32
M03_L01:
       mov       rcx,7FF8EFB1F9F4
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,rsi
       mov       rdx,rbx
       mov       rax,7FF8EF536208
       mov       [rbp-60],rax
       lea       rax,[M03_L02]
       mov       [rbp-50],rax
       lea       rax,[rbp-70]
...
M03_L05:
       ...
       jne       short M03_L07
M03_L06:
       mov       rcx,7FF8EFB1F9E8
       call      CORINFO_HELP_COUNTPROFILE32
       movzx     edi,dil
       jmp       short M03_L04
M03_L07:
       mov       rdx,rsi
       call      qword ptr [7FF8EFB24960]
       test      eax,eax
       je        near ptr M03_L00
       jmp       short M03_L06
M03_L08:
       mov       rcx,7FF8EFB1F9F0
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       near ptr M03_L01
; Total bytes of code 317
```
...
M08_L00:
       ...
       cmovl     edx,ecx
       mov       rcx,rbx
       call      qword ptr [7FF904049D08]; Precode of System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].set_Capacity(Int32)
       mov       [rbx+10],ebp
       mov       rcx,[rbx+8]
       movsxd    rdx,edi
       mov       r8,rsi
       call      qword ptr [7FF904024008]; Precode of System.Runtime.CompilerServices.CastHelpers.StelemRef(System.Object[], IntPtr, System.Object)
       nop
       add       rsp,28
       pop       rbx
       pop       rbp
...
M09_L04:
       ...
       pop       rdi
       pop       r14
       jmp       qword ptr [7FF8EF9EEAC0]
M09_L05:
       mov       rcx,7FF8EFB0D2A4
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L11
M09_L06:
       mov       rcx,7FF8EFB0D2A8
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L11
M09_L07:
       mov       rcx,7FF8EFB0D2AC
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L11
M09_L08:
       mov       rcx,7FF8EFB0D2B0
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L11
M09_L09:
       mov       rcx,7FF8EFB0D2B4
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L11
M09_L10:
       xor       esi,esi
       ...
       jmp       short M09_L12
M09_L11:
       mov       rcx,7FF8EFB0D2BC
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,rsi
       xor       edx,edx
       call      qword ptr [7FF8EFA7F6D8]; System.Array.GetLowerBound(Int32)
       mov       ebp,eax
M09_L12:
       test      rbx,rbx
       jne       short M09_L13
