...
|--------------- |-----:|------:|-------:|-------:|----:|---:|-------:|---:|----:|-----:|---------------:|-----------:|-----:|--------- |
| GetDescription |   NA |    NA |     NA |     NA |  NA | NA |     NA | NA |  NA |   NA |             NA |         NA |    ? | No       |

Benchmarks with issues:
  EnumExtensionsBenchmark.GetDescription: Job-PSYKRA(EvaluateOverhead=True, Runtime=.NET 10.0, Server=True)
