...
; DotNetTips.Spargine.Core.BenchmarkTests.Data.CountryPhonePostalInfoRepositoryBenchmark.ValidatePostalCode()
       ...
       call      qword ptr [7FF8245EF198]; DotNetTips.Spargine.Core.Data.CountryPhonePostalInfoRepository.GetCountryPhonePostalInfo()
       mov       rsi,rax
       mov       rcx,[rbx+8]
       mov       ecx,[rcx+8]
       cmp       ecx,2
...
M00_L05:
       ...
       mov       rdx,r8
       mov       r8d,r9d
       call      qword ptr [7FF82467C378]
       jmp       near ptr M00_L13
M00_L06:
       mov       rdx,r8
       mov       r8d,r9d
       call      qword ptr [7FF8245EFB10]; System.Globalization.Ordinal.EqualsIgnoreCase_Vector[[System.Runtime.Intrinsics.Vector128`1[[System.UInt16, System.Private.CoreLib]], System.Private.CoreLib]](Char ByRef, Char ByRef, Int32)
       jmp       near ptr M00_L13
M00_L07:
       xor       r12d,r12d
       cmp       r9d,4
...
M00_L50:
       mov       rcx,rbx
       call      qword ptr [7FF8245EFB28]; System.Text.RegularExpressions.RegexCache.GetOrAdd(System.String)
       mov       ecx,0A
       xor       edx,edx
       ...
       mov       r8d,0FFFFFFFF
       mov       r9,rsi
       call      qword ptr [7FF824674FD8]; System.Text.RegularExpressions.Regex.RunSingleMatch(System.Text.RegularExpressions.RegexRunnerMode, Int32, System.String, Int32, Int32, Int32)
       test      rax,rax
...
M00_L51:
       ...
       lea       rdx,[rbp-50]
       cmp       [rcx],ecx
       call      qword ptr [7FF824675260]; BenchmarkDotNet.Engines.Consumer.Consume[[DotNetTips.Spargine.Core.Data.PostalCodeState, DotNetTips.Spargine.10.Core]](DotNetTips.Spargine.Core.Data.PostalCodeState ByRef)
       nop
       add       rsp,58
       pop       rbx
       pop       rsi
...
M00_L59:
       ...
       mov       rdx,rsi
       mov       r8,r15
       mov       rcx,7FF8246633E8
       call      qword ptr [7FF8245EC018]; System.Linq.Enumerable.TryGetFirst[[System.__Canon, System.Private.CoreLib]](System.Collections.Generic.IEnumerable`1<System.__Canon>, System.Func`2<System.__Canon,Boolean>, Boolean ByRef)
       mov       r15,rax
       jmp       near ptr M00_L47
M00_L60:
       mov       rcx,offset MT_System.Func<DotNetTips.Spargine.Core.Data.Models.CountryPhonePostalInfo, System.Boolean>
...
M00_L61:
       mov       ecx,11
       call      qword ptr [7FF824117E58]
       int       3
M00_L62:
       call      qword ptr [7FF824117A08]
       int       3
M00_L63:
       mov       r11,7FF823E40B70
       call      qword ptr [r11]
       mov       r14d,eax
       test      r14d,r14d
       je        short M00_L66
...
M01_L00:
       ...
       jmp       short M01_L02
M01_L01:
       call      qword ptr [7FF8245EF1B0]; DotNetTips.Spargine.Core.Data.CountryPhonePostalInfoRepository.DeserializeCountryPhonePostalInfo()
       mov       rdx,rax
       mov       rcx,rsi
       call      CORINFO_HELP_ASSIGN_REF
       jmp       short M01_L00
...
; System.Globalization.Ordinal.EqualsIgnoreCase_Vector[[System.Runtime.Intrinsics.Vector128`1[[System.UInt16, System.Private.CoreLib]], System.Private.CoreLib]](Char ByRef, Char ByRef, Int32)
       ...
       lea       rax,[r9-8]
       xor       r10d,r10d
       vbroadcastss xmm0,dword ptr [7FF8246F1A90]
       vbroadcastss xmm1,dword ptr [7FF8246F1A94]
       vbroadcastss xmm2,dword ptr [7FF8246F1A98]
M02_L00:
...
M02_L10:
       ...
       vbroadcastss xmm6,dword ptr [7FF8246F1A9C]
       vpaddw    xmm5,xmm5,xmm6
       vpcmpgtw  xmm5,xmm5,[7FF8246F1AA0]
       vptest    xmm5,xmm5
...
M02_L25:
       ...
       vpcmpgtw  xmm0,xmm0,[7FF8246F1AA0]
       vptest    xmm0,xmm0
       jne       near ptr M02_L06
       vpcmpeqw  xmm3,xmm3,xmm4
       vpmovmskb eax,xmm3
...
M03_L02:
       mov       rcx,rdx
       mov       rdx,rax
       jmp       qword ptr [7FF8245EFAF8]; System.String.EqualsOrdinalIgnoreCaseNoLengthCheck(System.String, System.String)
M03_L03:
       mov       eax,1
       jmp       short M03_L01
...
M04_L07:
       mov       ecx,0C
       call      qword ptr [7FF82467E028]
       int       3
M04_L08:
       mov       ecx,2
       call      qword ptr [7FF82467C3D8]; System.Runtime.CompilerServices.StaticsHelpers.GetOptimizedGCThreadStaticBase(Int32)
       jmp       near ptr M04_L00
M04_L09:
       call      qword ptr [7FF824115E00]; System.Globalization.CultureInfo.InitializeUserDefaultCulture()
       mov       rsi,rax
...
M04_L14:
       ...
       mov       rcx,[rcx]
       lea       r8,[rsp+48]
       call      qword ptr [7FF824664BB0]; Precode of System.Collections.Concurrent.ConcurrentDictionary`2[[System.Text.RegularExpressions.RegexCache+Key, System.Text.RegularExpressions],[System.__Canon, System.Private.CoreLib]].TryGetValue(Key, System.__Canon ByRef)
       test      eax,eax
       je        short M04_L15
       mov       rcx,[rsp+48]
       inc       rbp
...
M04_L16:
       ...
       mov       rdx,rbx
       mov       r8,rsi
       call      qword ptr [7FF8245EFDC8]; System.Text.RegularExpressions.Regex..ctor(System.String, System.Globalization.CultureInfo)
       mov       [rsp+28],rbx
       mov       [rsp+30],rdi
       xor       ecx,ecx
       mov       [rsp+38],ecx
       ...
       lea       rcx,[rsp+28]
       mov       rdx,rbp
       call      qword ptr [7FF824674F00]; System.Text.RegularExpressions.RegexCache.Add(Key, System.Text.RegularExpressions.Regex)
...
M05_L00:
       ...
       mov       rcx,rax
       cmp       [rcx],ecx
       call      qword ptr [7FF824675068]; System.Text.RegularExpressions.RegexRunner.InitializeTimeout(System.TimeSpan)
       mov       rax,[rbp-60]
       lea       rcx,[rax+8]
       mov       rdx,rbx
       call      CORINFO_HELP_ASSIGN_REF
...
M05_L11:
       ...
       mov       rcx,rdx
       mov       rdx,rax
       call      qword ptr [7FF8246750F8]; System.Text.RegularExpressions.Match..ctor(System.Text.RegularExpressions.Regex, Int32, System.String, Int32)
       mov       rdx,[rbp-70]
       lea       rcx,[rdx+68]
       mov       rdx,[rbp-78]
       call      CORINFO_HELP_ASSIGN_REF
...
; BenchmarkDotNet.Engines.Consumer.Consume[[DotNetTips.Spargine.Core.Data.PostalCodeState, DotNetTips.Spargine.10.Core]](DotNetTips.Spargine.Core.Data.PostalCodeState ByRef)
       mov       rcx,rdx
       jmp       qword ptr [7FF8246752A8]; BenchmarkDotNet.Engines.DeadCodeEliminationHelper.KeepAliveWithoutBoxingReadonly[[DotNetTips.Spargine.Core.Data.PostalCodeState, DotNetTips.Spargine.10.Core]](DotNetTips.Spargine.Core.Data.PostalCodeState ByRef)
...
M08_L29:
       mov       rcx,rbx
       mov       rdx,7FF824777068
       call      qword ptr [7FF824117B58]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       r11,rax
...
M08_L66:
       mov       rcx,rbx
       mov       rdx,7FF824776F08
       call      qword ptr [7FF824117B58]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       r14,rax
       jmp       near ptr M08_L00
M08_L67:
       mov       rcx,r14
       mov       rdx,7FF8247772A8
       call      qword ptr [7FF824117B58]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       jmp       near ptr M08_L01
M08_L68:
       mov       rcx,r14
       mov       rdx,7FF824777338
       call      qword ptr [7FF824117B58]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       jmp       near ptr M08_L02
M08_L69:
       mov       rcx,rbx
       mov       rdx,7FF824776FB0
       call      qword ptr [7FF824117B58]; System.Runtime.CompilerServices.GenericsHelpers.Method(IntPtr, IntPtr)
       mov       r11,rax
...
; DotNetTips.Spargine.Core.BenchmarkTests.Data.CountryPhonePostalInfoRepositoryBenchmark.GetCountryPhonePostalInfo()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FF82461F0D8]; DotNetTips.Spargine.Core.Data.CountryPhonePostalInfoRepository.GetCountryPhonePostalInfo()
       mov       [rsp+28],rax
       mov       rbx,[rbx+60]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
M01_L00:
       ...
       jmp       short M01_L02
M01_L01:
       call      qword ptr [7FF82461F0F0]; DotNetTips.Spargine.Core.Data.CountryPhonePostalInfoRepository.DeserializeCountryPhonePostalInfo()
       mov       rdx,rax
       mov       rcx,rsi
       call      CORINFO_HELP_ASSIGN_REF
       jmp       short M01_L00
