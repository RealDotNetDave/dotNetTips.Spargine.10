...
M00_L02:
       ...
       mov       rcx,r10
       mov       rdx,rsi
       call      qword ptr [7FF9F7A560A0]; System.Enum.Equals(System.Object)
M00_L03:
       test      eax,eax
       je        near ptr M00_L12
M00_L04:
...
M00_L09:
       ...
       call      qword ptr [7FF9F7B16BB0]; System.MulticastDelegate.CtorClosed(System.Object, IntPtr)
       mov       rcx,13EFE800110
       mov       rdx,rdi
       call      CORINFO_HELP_ASSIGN_REF
...
M00_L18:
       ...
       mov       r8,rsi
       mov       rcx,r14
       call      qword ptr [7FF9F7F6C270]; System.Collections.Concurrent.ConcurrentDictionary`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].TryAddInternal(Tables<System.__Canon,System.__Canon>, System.__Canon, System.Nullable`1<Int32>, System.__Canon, Boolean, Boolean, System.__Canon ByRef)
...
M02_L00:
       mov       rcx,[rbp-8]
       mov       rdx,[rbp+18]
       call      qword ptr [7FF9F82F5458]; System.Enum.GetName(System.Type, System.Object)
       mov       [rbp-10],rax
; 			if (name == null)
; 			^^^^^^^^^^^^^^^^^
...
M02_L01:
       ...
       mov       rdx,[rbp-10]
       cmp       [rcx],ecx
       call      qword ptr [7FF9F82F5470]; System.Type.GetField(System.String)
       mov       [rbp-18],rax
; 			if (field == null)
; 			^^^^^^^^^^^^^^^^^^
       mov       rcx,[rbp-18]
       xor       edx,edx
       call      qword ptr [7FF9F82F5488]; System.Reflection.FieldInfo.op_Equality(System.Reflection.FieldInfo, System.Reflection.FieldInfo)
       test      eax,eax
       je        short M02_L02
; 				return name;
; 				^^^^^^^^^^^^
...
M02_L02:
       mov       rdx,[rbp-18]
       mov       rcx,7FF9F82ECA00
       xor       r8d,r8d
       call      qword ptr [7FF9F80F5968]; System.Reflection.CustomAttributeExtensions.GetCustomAttribute[[System.__Canon, System.Private.CoreLib]](System.Reflection.MemberInfo, Boolean)
       mov       [rbp-20],rax
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,rax
       call      qword ptr [7FF9F7D9E0E8]; System.String.IsNullOrEmpty(System.String)
       test      eax,eax
       jne       short M02_L03
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,[rbp-28]
       cmp       [rcx],ecx
       call      qword ptr [7FF9F82F54B8]; System.Runtime.Serialization.EnumMemberAttribute.get_Value()
       mov       rcx,rax
       call      qword ptr [7FF9F7D9E0E8]; System.String.IsNullOrEmpty(System.String)
       test      eax,eax
       jne       short M02_L04
...
; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetDescription_NoCache()
       ...
       mov       rcx,rax
       call      qword ptr [7FF9F822EE98]; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetDescriptionNoCache(System.Enum)
       mov       [rsp+28],rax
       mov       rbx,[rbx+60]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetDescriptionNoCache(System.Enum)
       ...
       je        near ptr M01_L49
       mov       rcx,rbx
       call      qword ptr [7FF9F7D761C0]; System.Object.GetType()
       mov       rsi,rax
       mov       rcx,[rsi+18]
       test      cl,2
...
M01_L02:
       mov       rcx,rbx
       call      qword ptr [7FF9F822EFA0]; System.Enum.ToUInt64(System.Object)
       mov       rdx,rax
       mov       rcx,rsi
       call      qword ptr [7FF9F822F000]; System.Enum.GetName(System.RuntimeType, UInt64)
       mov       rdi,rax
       test      rdi,rdi
       je        near ptr M01_L53
       mov       rcx,rsi
       mov       rdx,rdi
       mov       r8d,1C
       call      qword ptr [7FF9F7A4A490]; System.RuntimeType.GetField(System.String, System.Reflection.BindingFlags)
       mov       rbx,rax
       test      rbx,rbx
...
M01_L13:
       ...
       mov       r8d,[rsp+0A0]
       mov       r9,331422D06C0
       call      qword ptr [7FF9F7D772A0]; System.Reflection.CustomAttribute.GetCustomAttributes(System.Reflection.RuntimeModule, Int32, Int32, System.RuntimeType)
       mov       rsi,rax
...
M01_L19:
       mov       rcx,[rsp+40]
       call      qword ptr [7FF9F7D77258]; System.Runtime.CompilerServices.RuntimeHelpers.<GetHashCode>g__GetHashCodeWorker|15_0(System.Object)
...
M01_L23:
       ...
       cmp       [rsi],rcx
       je        short M01_L24
       call      qword ptr [7FF9F7D74D20]; System.Runtime.CompilerServices.CastHelpers.ChkCastClassSpecial(Void*, System.Object)
       mov       rsi,rax
M01_L24:
       test      rsi,rsi
...
M01_L48:
       ...
       ret
M01_L49:
       call      qword ptr [7FF9F817E220]
       mov       ecx,7
       mov       rdx,7FF9F7EA3D80
       call      qword ptr [7FF9F7B0F210]
       mov       rbx,rax
       mov       ecx,1B77
       mov       rdx,7FF9F7EA5728
       call      qword ptr [7FF9F7B0F210]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF9F7B0D9C8]; System.String.Concat(System.String, System.String)
       mov       rbx,rax
       mov       ecx,5
       mov       rdx,7FF9F7EA3D80
       call      qword ptr [7FF9F7B0F210]
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FF9F82CDF50]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF9F82C6A30]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
M01_L50:
       mov       rcx,rsi
       mov       rdx,331422C6D90
       call      qword ptr [7FF9F7A4A608]; System.RuntimeType.IsSubclassOf(System.Type)
...
M01_L51:
       ...
       mov       rdx,rsi
       mov       rcx,rbx
       call      qword ptr [7FF9F7F55E00]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M01_L52:
       mov       rcx,rsi
       call      qword ptr [7FF9F82C7F60]; System.Type.IsIntegerType(System.Type)
       test      eax,eax
       jne       near ptr M01_L02
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF9F82C7F78]
       mov       rsi,rax
       mov       ecx,3AD
...
M01_L56:
       ...
       mov       rcx,r13
       cmp       [rcx],ecx
       call      qword ptr [7FF9F7D769A0]; System.RuntimeType.get_IsActualInterface()
       test      eax,eax
       jne       short M01_L58
       mov       rcx,r13
       call      00007FFA576F2C30
...
M01_L61:
       ...
       jmp       near ptr M01_L03
M01_L62:
       call      qword ptr [7FF9F7D77078]; System.RuntimeType.GetBaseType()
       mov       rcx,rax
       test      rcx,rcx
...
M01_L63:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF9F82C6EC8]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF9F7E6FF00]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M01_L64:
...
M01_L65:
       ...
       mov       rdx,rsi
       xor       r8d,r8d
       call      qword ptr [7FF9F80FC270]; System.Attribute.InternalGetCustomAttributes(System.Reflection.PropertyInfo, System.Type, Boolean)
       mov       r15,rax
...
M01_L71:
       mov       rcx,rsi
       call      qword ptr [7FF9F7D75710]; System.RuntimeTypeHandle.<GetModule>g__GetModuleWorker|48_0(System.RuntimeType)
       mov       rcx,rax
...
M01_L74:
       ...
       mov       r8,rsi
       xor       edx,edx
       call      qword ptr [7FF9F82C4D20]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M01_L14
M01_L75:
       mov       rcx,rbx
       mov       rdx,rsi
...
M01_L94:
       ...
       mov       rcx,r15
       mov       r8,331422D06E8
       mov       r11,7FF9F7A50B98
       call      qword ptr [r11]
       test      eax,eax
       je        near ptr M01_L35
       jmp       near ptr M01_L36
M01_L95:
       call      qword ptr [7FF9F7B0F480]
       int       3
M01_L96:
       mov       rcx,rsi
       call      qword ptr [7FF9F7D75710]; System.RuntimeTypeHandle.<GetModule>g__GetModuleWorker|48_0(System.RuntimeType)
