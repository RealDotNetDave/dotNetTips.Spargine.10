...
public static partial class ExceptionThrower
{
	...
	public static string DefaultIfNull(this string value, string defaultValue) => value ?? defaultValue;
	...
	public static void ThrowArgumentException([AllowNull] string message, [DisallowNull] string paramName)
	{
		throw new ArgumentException(message ?? Resources.ErrorInvalidArgument, paramName);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information("Optimized ThrowArgumentException method for better performance and clarity.", UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowArgumentException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new ArgumentException(message ?? Resources.ErrorInvalidArgument, innerException);
	}
	...
	public static void ThrowArgumentInvalidException([AllowNull] string message, [DisallowNull] string paramName)
	{
		throw new ArgumentInvalidException(message ?? Resources.ErrorInvalidArgument, paramName);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowArgumentInvalidException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowArgumentInvalidException([AllowNull] string message, [DisallowNull] string paramName, [AllowNull] Exception innerException)
	{
		throw new ArgumentInvalidException(message ?? Resources.ErrorInvalidArgument, paramName, innerException!);
	}
	...
	public static void ThrowArgumentNullException([DisallowNull] string paramName)
	{
		throw new ArgumentNullException(paramName, Resources.ErrorArgumentNull);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowArgumentNullException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowArgumentNullException([AllowNull] string message, [DisallowNull] string paramName)
	{
		throw new ArgumentNullException(paramName, message ?? Resources.ErrorArgumentNull);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowArgumentNullException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowArgumentNullException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new ArgumentNullException(message ?? Resources.ErrorArgumentNull, innerException);
	}
	...
	public static void ThrowArgumentOutOfRangeException([DisallowNull] string paramName)
	{
		throw new ArgumentOutOfRangeException(paramName, Resources.ErrorArgumentOutOfRange);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowArgumentOutOfRangeException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowArgumentOutOfRangeException([AllowNull] string message, [DisallowNull] string paramName)
	{
		throw new ArgumentOutOfRangeException(paramName, message ?? Resources.ErrorArgumentOutOfRange);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowArgumentOutOfRangeException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowArgumentOutOfRangeException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new ArgumentOutOfRangeException(message ?? Resources.ErrorArgumentOutOfRange, innerException);
	}
	...
	public static void ThrowArgumentReadOnlyException([AllowNull] string message, [DisallowNull] string paramName)
	{
		throw new ArgumentReadOnlyException(message ?? Resources.ErrorReadOnlyCollection, paramName);
	}
	...
	public static void ThrowDirectoryNotFoundException([AllowNull] string message, DirectoryInfo directory)
	{
		throw new DirectoryNotFoundException(message ?? Resources.ErrorDirectoryNotFound, directory.ArgumentNotNull());
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowDirectoryNotFoundException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowDirectoryNotFoundException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new ArgumentInvalidException(message ?? Resources.ErrorDirectoryNotFound, innerException!);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowFileNotFoundException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowFileNotFoundException([AllowNull] string message, [DisallowNull] string fileName)
	{
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowFileNotFoundException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowFileNotFoundException([AllowNull] string message, [DisallowNull] string fileName, [AllowNull] Exception innerException)
	{
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowInvalidCastException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowInvalidCastException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new InvalidCastException(message ?? Resources.ErrorInvalidCast, innerException);
	}
	...
	public static void ThrowInvalidEnumTypeException([AllowNull] string message)
	{
		throw new InvalidEnumTypeException(message ?? Resources.ErrorInvalidEnumType);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowInvalidEnumTypeException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowInvalidEnumTypeException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new InvalidCastException(message ?? Resources.ErrorInvalidEnumType, innerException);
	}
	...
	public static void ThrowInvalidOperationException([AllowNull] string message)
	{
		throw new InvalidOperationException(message ?? Resources.ErrorInvalidOperation);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information("From .NET Core source.", UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowInvalidOperationException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new InvalidOperationException(message ?? Resources.ErrorInvalidOperation);
	}
	...
	public static void ThrowInvalidValueException<TValue>([AllowNull] string message, [DisallowNull] TValue value)
	{
		throw new InvalidValueException<TValue>(message ?? Resources.ErrorInvalidValue, value: value);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowInvalidValueException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowInvalidValueException<TValue>([AllowNull] string message, [DisallowNull] TValue value, [AllowNull] Exception innerException)
	{
		throw new InvalidValueException<TValue>(message ?? Resources.ErrorInvalidValue, value: value, innerException: innerException);
	}
	...
	public static void ThrowIOException([AllowNull] string message)
	{
		throw new IOException(message ?? Resources.ErrorUnknownIOException);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowIOException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowIOException([AllowNull] string message, Exception innerException)
	{
		throw new IOException(message ?? Resources.ErrorUnknownIOException, innerException);
	}
	...
	public static void ThrowJsonException([AllowNull] string message)
	{
		throw new JsonException(message ?? Resources.ErrorThereWasAnErrorWithJsonSerialization);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowJsonException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowJsonException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new JsonException(message ?? Resources.ErrorThereWasAnErrorWithJsonSerialization, innerException);
	}
	...
	public static void ThrowMessageNotQueuedException([AllowNull] string message)
	{
		throw new MessageNotQueuedException(message ?? Resources.ErrorMessageNotQueued);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowMessageNotQueuedException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowMessageNotQueuedException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new MessageNotQueuedException(message ?? Resources.ErrorMessageNotQueued, innerException!);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowMessageNotQueuedException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowMessageNotQueuedException([AllowNull] string message, [AllowNull] string messageId)
	{
		throw new MessageNotQueuedException(message ?? Resources.ErrorMessageNotQueued, messageId!);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowMessageNotQueuedException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowMessageNotQueuedException([AllowNull] string message, [AllowNull] string messageId, [AllowNull] Exception innerException)
	{
		throw new MessageNotQueuedException(message ?? Resources.ErrorMessageNotQueued, messageId!, innerException!);
	}
	...
	public static void ThrowNetworkConnectionException([AllowNull] string message)
	{
		throw new NetworkConnectionException(message ?? Resources.ErrorNetworkConnectionIssue);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowNetworkConnectionException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowNetworkConnectionException([AllowNull] string message, [AllowNull] Exception innerException)
	{
		throw new NetworkConnectionException(message ?? Resources.ErrorNetworkConnectionIssue, innerException!);
	}
	...
	[ExcludeFromCodeCoverage(Justification = "Not needed for this pass-through method.")]
	[Information(nameof(ThrowNetworkConnectionException), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static void ThrowNetworkConnectionException([AllowNull] string message, [AllowNull] NetworkInterface connection)
	{
		throw new NetworkConnectionException(message ?? Resources.ErrorNetworkConnectionIssue, connection!);
	}
