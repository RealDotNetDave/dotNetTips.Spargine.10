...
public sealed class PerformanceStopwatch : Stopwatch
{
	...
	public string ExportToJson() => JsonSerializer.Serialize(
			new
			{
				this.Title,
	...
	/// <summary>
	/// Starts a new instance of <see cref="PerformanceStopwatch"/> with a specified alert threshold and optional _title.
	/// </summary>
	/// <param name="alertThreshold">The threshold for performance alerts.</param>
	/// <param name="title">An optional _title for the stopwatch instance.</param>
	/// <returns>A new instance of <see cref="PerformanceStopwatch"/> configured with the specified alert threshold and _title.</returns>
	[Information(nameof(StartNew), "David McCarter", "5/8/2025", UnitTestStatus = UnitTestStatus.Completed, Status = Status.New)]
