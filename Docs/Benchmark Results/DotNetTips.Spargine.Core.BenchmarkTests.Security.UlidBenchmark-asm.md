...
M00_L00:
       cmp       [rcx],ecx
       call      qword ptr [7FF91C38AAC0]; System.MulticastDelegate.GetHashCode()
       mov       rcx,[rbx+60]
       mov       [rcx+38],eax
       add       rsp,28
       pop       rbx
...
M01_L00:
       ...
       je        short M01_L05
       mov       rcx,rbx
       call      qword ptr [7FF91C35C9A8]; System.Object.GetType()
       mov       rbx,rax
       mov       rcx,rbx
...
M01_L02:
       ...
       pop       rsi
       pop       rdi
       jmp       qword ptr [7FF91C35EEB0]; System.Runtime.CompilerServices.RuntimeHelpers.<GetHashCode>g__GetHashCodeWorker|15_0(System.Object)
M01_L03:
       mov       rcx,[rbx+18]
       mov       rdx,[rbx+20]
       add       rsp,28
...
M01_L06:
       mov       rcx,[rbx+8]
       call      qword ptr [7FF91C854558]; System.Runtime.CompilerServices.RuntimeHelpers.GetHashCode(System.Object)
       mov       esi,eax
       shl       esi,5
       add       esi,eax
M01_L07:
...
; DotNetTips.Spargine.Core.BenchmarkTests.Security.UlidBenchmark.GetTimeStamp()
       ...
       mov       [rsp+50],rax
       mov       rbx,rcx
       call      qword ptr [7FF91C98D7D0]; DotNetTips.Spargine.Core.Ulid.NewUlid()
       test      rax,rax
       je        near ptr M00_L03
...
M00_L01:
       ...
       cmp       [rcx],cl
       lea       rcx,[rsp+20]
       call      qword ptr [7FF91C98DA70]; BenchmarkDotNet.Engines.DeadCodeEliminationHelper.KeepAliveWithoutBoxingReadonly[[System.DateTimeOffset, System.Private.CoreLib]](System.DateTimeOffset ByRef)
       nop
       vzeroupper
       add       rsp,58
       pop       rbx
...
M00_L04:
       ...
       mov       edx,1D
       mov       r8d,1
       call      qword ptr [7FF91C584E70]; System.Runtime.CompilerServices.DefaultInterpolatedStringHandler..ctor(Int32, Int32)
       mov       ecx,[rsp+40]
       cmp       ecx,[rsp+50]
       ja        short M00_L07
       mov       rdx,[rsp+48]
...
M00_L05:
       lea       rcx,[rsp+30]
       mov       rdx,19EA88307F8
       call      qword ptr [7FF91C9870D8]
M00_L06:
       lea       rcx,[rsp+30]
       mov       edx,esi
       call      qword ptr [7FF91C9875E8]; System.Runtime.CompilerServices.DefaultInterpolatedStringHandler.AppendFormatted[[System.Char, System.Private.CoreLib]](Char)
       mov       ecx,[rsp+40]
       cmp       ecx,[rsp+50]
       jbe       short M00_L08
M00_L07:
...
M00_L10:
       lea       rcx,[rsp+30]
       call      qword ptr [7FF91C584EA0]; System.Runtime.CompilerServices.DefaultInterpolatedStringHandler.ToStringAndClear()
       mov       rbx,rax
       test      rbx,rbx
       jne       short M00_L11
       call      qword ptr [7FF91CA25A88]
       mov       rbx,rax
M00_L11:
...
; 		^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       lea       rdi,[rbp+30]
       lea       rcx,[rbp+20]
       call      qword ptr [7FF91C985518]; System.DateTimeOffset.get_UtcNow()
...
M01_L05:
       ...
       mov       rcx,rdi
       mov       edx,0A
       call      qword ptr [7FF91C774A80]; System.Security.Cryptography.RandomNumberGeneratorImplementation.GetBytes(Byte*, Int32)
       xor       ecx,ecx
       mov       [rbp+10],rcx
       mov       [rbp+10],rcx
       xor       eax,eax
...
M01_L11:
       ...
       mov       rdx,rax
       lea       rcx,[rbp+18]
       call      qword ptr [7FF91C98D830]; DotNetTips.Spargine.Core.Ulid..ctor(System.String)
       mov       rax,[rbp+18]
       mov       r8,0B6D8A1D39B37
       cmp       [rbp+48],r8
       je        short M01_L12
