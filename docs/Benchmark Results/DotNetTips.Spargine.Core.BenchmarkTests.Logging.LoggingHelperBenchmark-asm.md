...
; DotNetTips.Spargine.Core.BenchmarkTests.Logging.LoggingHelperBenchmark.RetrieveAllExceptionMessages()
       ...
       mov       rcx,rdi
       call      qword ptr [7FFA4A5EF378]; DotNetTips.Spargine.Core.Logging.LoggingHelper.RetrieveAllExceptions(System.Exception)
       mov       rsi,rax
       mov       rcx,18B3F400158
       mov       rdi,[rcx]
       test      rdi,rdi
...
M00_L10:
       ...
       mov       r8d,[rbp+10]
       mov       rdx,r14
       call      qword ptr [7FFA4A0D4FD8]; System.Array.Copy(System.Array, System.Array, Int32)
M00_L11:
       lea       rcx,[rbp+8]
       mov       rdx,r14
       call      CORINFO_HELP_ASSIGN_REF
...
M00_L28:
       call      qword ptr [7FFA4A6AD020]
       int       3
M00_L29:
       mov       rcx,r8
       call      qword ptr [7FFA49F357E8]; System.SpanHelpers.ClearWithoutReferences(Byte ByRef, UIntPtr)
       jmp       near ptr M00_L05
M00_L30:
       mov       rcx,rsi
       mov       rax,[rsi]
...
M01_L02:
       mov       rcx,rsi
       mov       rdx,rbx
       call      qword ptr [7FFA4A0DE370]; System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].AddWithResize(System.__Canon)
       jmp       short M01_L01
M01_L03:
       call      qword ptr [7FFA4A54DDD0]
       mov       ecx,1D61
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FFA4A6ACC90]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FFA4A6A7F30]
       mov       rcx,rsi
...
M03_L05:
       pop       rbx
       pop       rsi
       jmp       qword ptr [7FFA49F3D908]; System.Runtime.CompilerServices.CastHelpers.IsInstanceOfAny_NoCacheLookup(Void*, System.Object)
...
M04_L01:
       test      rbx,rbx
       jne       short M04_L04
       mov       rcx,7FFA4A6D1464
       call      CORINFO_HELP_COUNTPROFILE32
M04_L02:
       mov       rcx,7FFA4A6D146C
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,[rsi]
       mov       ecx,[rcx+4]
       add       ecx,0FFFFFFE8
...
M04_L04:
       ...
       cmp       r15,[rbx]
       je        short M04_L05
       mov       rcx,7FFA4A6D1460
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M04_L02
M04_L05:
       cmp       dword ptr [r15+4],18
       je        short M04_L06
       mov       rcx,7FFA4A6D145C
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M04_L02
M04_L06:
       cmp       edi,[rsi+8]
       jbe       short M04_L07
       mov       rcx,7FFA4A6D1458
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M04_L02
M04_L07:
       cmp       edi,[rbx+8]
       jbe       near ptr M04_L13
       mov       rcx,7FFA4A6D1454
       call      CORINFO_HELP_COUNTPROFILE32
...
M04_L10:
       ...
       mov       r8,rbx
       mov       r9d,r15d
       call      qword ptr [7FFA4A6A57D0]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
M04_L11:
       nop
       add       rsp,38
       pop       rbx
...
M04_L14:
       ...
       pop       r14
       pop       r15
       jmp       qword ptr [7FFA4A54DC38]
M04_L15:
       mov       rcx,7FFA4A6D1468
       call      CORINFO_HELP_COUNTPROFILE32
       cmp       rdi,19
       jne       short M04_L16
...
; 		                                       ^^^^^^^^^^
       ...
       cmp       [rcx],rax
       jne       short M05_L00
       jmp       qword ptr [7FFA49FABC20]; System.ArgumentException.get_Message()
M05_L00:
       mov       rax,[rcx]
       mov       rax,[rax+40]
...
M07_L02:
       ...
       pop       r14
       pop       r15
       jmp       qword ptr [7FFA4A0DFF48]; System.Runtime.CompilerServices.VirtualDispatchHelpers.VirtualFunctionPointerSlow(System.Object, IntPtr, IntPtr)
...
M01_L03:
       ...
       jmp       short M01_L08
M01_L04:
       mov       rdx,7FFA4A62D338
       call      qword ptr [7FFA49F3C5B8]; System.Runtime.CompilerServices.GenericsHelpers.Class(IntPtr, IntPtr)
       mov       rdx,rax
       jmp       short M01_L03
M01_L05:
       mov       rcx,[rbx]
...
; System.Runtime.CompilerServices.CastHelpers.StelemRef(System.Object[], IntPtr, System.Object)
       ...
       mov       rcx,rax
       add       rsp,28
       jmp       qword ptr [7FFA49F3D8F0]; System.Runtime.CompilerServices.CastHelpers.StelemRef_Helper(System.Object ByRef, Void*, System.Object)
M02_L00:
       call      qword ptr [7FFA4A6842A0]
       int       3
M02_L01:
       mov       rcx,rax
       mov       rdx,r8
