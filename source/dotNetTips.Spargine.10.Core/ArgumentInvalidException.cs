...
// ***********************************************************************
// <copyright file="ArgumentInvalidException.cs" company="dotNetTips.com - McCarter Consulting">
...
public sealed class ArgumentInvalidException : ArgumentException
{
	...
	public ArgumentInvalidException([DisallowNull] string message) : base(message)
	{
	}
	...
	public ArgumentInvalidException([DisallowNull] string message, [DisallowNull] Exception innerException) : base(message, innerException)
	{
	}
	...
	public ArgumentInvalidException([DisallowNull] string message, [DisallowNull] string paramName) : base(message, paramName)
	{
	}
	...
	public ArgumentInvalidException([DisallowNull] string message, [DisallowNull] string paramName, [DisallowNull] Exception innerException) : base(message, paramName, innerException)
	{
	}
}
