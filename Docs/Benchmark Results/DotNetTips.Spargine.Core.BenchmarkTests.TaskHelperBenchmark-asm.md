...
M00_L00:
       ...
       test      rax,rax
       jne       short M00_L01
       call      qword ptr [7FF8A7E1FD98]; System.Threading.Thread.InitializeCurrentThread()
M00_L01:
       mov       rbx,[rax+8]
       test      rbx,rbx
...
M00_L05:
       mov       rcx,rdi
       xor       edx,edx
       call      qword ptr [7FF8A821E910]; System.Threading.Tasks.Task.ScheduleAndStart(Boolean)
       mov       ecx,[rdi+34]
       and       ecx,11000000
       cmp       ecx,1000000
...
M00_L07:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FF8A82AD0F8]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF8A82AC2B8]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
M00_L08:
       mov       ecx,4
       call      qword ptr [7FF8A82A6AC0]; System.Runtime.CompilerServices.StaticsHelpers.GetOptimizedGCThreadStaticBase(Int32)
...
M00_L10:
       mov       rcx,rdi
       xor       edx,edx
       call      qword ptr [7FF8A821F0A8]; System.Runtime.CompilerServices.TaskAwaiter.HandleNonSuccessAndDebuggerNotification(System.Threading.Tasks.Task, System.Threading.Tasks.ConfigureAwaitOptions)
...
; 		                                         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,[rbx+8]
       lea       rdx,[rsp+28]
       call      qword ptr [7FF8A7F7E4F0]; DotNetTips.Spargine.Core.BenchmarkTests.TaskHelperBenchmark+<>c.<Setup>b__4_1()
M01_L00:
       mov       rbx,[rsp+28]
       test      rbx,rbx
       je        short M01_L05
...
M03_L09:
       ...
       mov       rcx,rbx
       call      qword ptr [7FF8A821EDA8]; System.Threading.PortableThreadPool+WorkerThread.MaybeAddWorkingWorker(System.Threading.PortableThreadPool)
       cmp       dword ptr [rbx+17C],6
       je        near ptr M03_L18
       jmp       near ptr M03_L16
M03_L10:
       mov       rdx,rsi
       call      qword ptr [7FF8A82A7AF8]
       mov       rcx,[rbp+10]
...
M03_L11:
       ...
       mov       rcx,rsi
       mov       rdx,rbx
       call      qword ptr [7FF8A82AD128]
       mov       rcx,rsi
       mov       edx,1
       call      qword ptr [7FF8A821EF10]; System.Threading.Thread.set_IsBackground(Boolean)
       mov       rcx,rsi
       mov       rdx,22F2D9D0B98
       call      qword ptr [7FF8A821F018]; System.Threading.Thread.set_Name(System.String)
       mov       rcx,rsi
       mov       rdx,[rbp+10]
       xor       r8d,r8d
       call      qword ptr [7FF8A82AD140]
...
M03_L16:
       mov       rcx,rbx
       call      qword ptr [7FF8A821EF88]; System.Threading.PortableThreadPool+GateThread.EnsureRunningSlow(System.Threading.PortableThreadPool)
       jmp       short M03_L18
M03_L17:
       mov       rcx,rsi
       mov       rdx,[rbp+10]
...
M03_L18:
       ...
       ret
M03_L19:
       call      qword ptr [7FF8A82AD110]
       test      eax,eax
       mov       rcx,[rbp+10]
       jne       near ptr M03_L00
       jmp       short M03_L18
M03_L20:
       call      qword ptr [7FF8A821FB58]
       mov       rcx,[rbp+10]
       jmp       near ptr M03_L01
M03_L21:
       test      word ptr [rcx+34],200
       jne       near ptr M03_L02
       call      qword ptr [7FF8A821FDE0]
       mov       esi,eax
       mov       rcx,[rbp+10]
       mov       rcx,[rcx+8]
       call      qword ptr [7FF8A82A7A80]
       mov       rdx,rax
       mov       rcx,22F2D9D0B10
       call      qword ptr [7FF8A7BF7840]; System.String.Concat(System.String, System.String)
       mov       r8,rax
       ...
       mov       rcx,rsi
       mov       rdx,rbx
       call      qword ptr [7FF8A82A78E8]
       mov       rcx,[rbp+10]
       mov       rdx,rsi
       call      qword ptr [7FF8A82A7AB0]
       mov       rcx,[rbp+10]
       xor       edx,edx
       call      qword ptr [7FF8A82A7AC8]
       mov       rcx,[rbp+10]
       call      qword ptr [7FF8A82A7AE0]
       test      eax,200
       jne       short M03_L22
       mov       rcx,[rbp+10]
       mov       rcx,[rcx+28]
...
; System.Runtime.CompilerServices.TaskAwaiter.HandleNonSuccessAndDebuggerNotification(System.Threading.Tasks.Task, System.Threading.Tasks.ConfigureAwaitOptions)
       ...
       mov       edx,0FFFFFFFF
       xor       r8d,r8d
       call      qword ptr [7FF8A821F0C0]; System.Threading.Tasks.Task.InternalWait(Int32, System.Threading.CancellationToken)
M06_L00:
...
M06_L03:
       ...
       je        short M06_L01
       mov       rcx,rbx
       call      qword ptr [7FF8A82A79C0]
       jmp       short M06_L01
M06_L04:
       test      sil,2
       jne       short M06_L05
       mov       rcx,rbx
       call      qword ptr [7FF8A82A7858]
M06_L05:
       mov       rcx,rbx
       call      qword ptr [7FF8A82AD080]
       jmp       short M06_L02
