...
M00_L01:
       ...
       ret
M00_L02:
       mov       r11,7FFD574E0CE8
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L03:
       mov       r11,7FFD574E0CE0
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L04:
...
M00_L01:
       ...
       ret
M00_L02:
       mov       r11,7FFD574D0DA8
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L03:
       mov       r11,7FFD574D0DA0
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L04:
...
M00_L01:
       ...
       ret
M00_L02:
       mov       r11,7FFD574C0EE8
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L03:
       mov       r11,7FFD574C0EE0
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L04:
...
M00_L01:
       ...
       ret
M00_L02:
       mov       r11,7FFD574D1218
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L03:
       mov       r11,7FFD574D1210
       call      qword ptr [r11]
       mov       esi,eax
       jmp       short M00_L00
M00_L04:
...
M00_L27:
       mov       rcx,offset MT_System.SZGenericArrayEnumerator<DotNetTips.Spargine.Tester.Models.RefTypes.Person>
       call      qword ptr [7FFD575A5728]; System.Runtime.CompilerServices.StaticsHelpers.GetGCStaticBase(System.Runtime.CompilerServices.MethodTable*)
       mov       rcx,24DF0800A28
       mov       r15,[rcx]
       jmp       near ptr M00_L06
M00_L28:
...
M00_L27:
       mov       rcx,offset MT_System.SZGenericArrayEnumerator<DotNetTips.Spargine.Tester.Models.RefTypes.Person>
       call      qword ptr [7FFD57565728]; System.Runtime.CompilerServices.StaticsHelpers.GetGCStaticBase(System.Runtime.CompilerServices.MethodTable*)
       mov       rcx,1C0E9800A28
       mov       r15,[rcx]
       jmp       near ptr M00_L06
M00_L28:
...
M00_L28:
       mov       rcx,rbx
       mov       r11,7FFD574B0EE8
       call      qword ptr [r11]
       mov       r15,rax
       jmp       near ptr M00_L03
M00_L29:
       mov       rcx,rbx
       mov       r11,7FFD574B0EC8
       call      qword ptr [r11]
       mov       r15,rax
       jmp       near ptr M00_L03
M00_L30:
...
M00_L27:
       mov       rcx,rbx
       mov       r11,7FFD574E11F0
       call      qword ptr [r11]
       mov       rcx,rax
       jmp       near ptr M00_L03
M00_L28:
       mov       rcx,rax
       mov       r11,7FFD574E1208
       call      qword ptr [r11]
       jmp       near ptr M00_L18
M00_L29:
       xor       ebx,ebx
