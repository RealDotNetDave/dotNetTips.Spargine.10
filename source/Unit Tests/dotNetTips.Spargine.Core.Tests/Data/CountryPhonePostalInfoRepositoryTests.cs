...
public class CountryPhonePostalInfoRepositoryTests
{
	...
	{
		var result = CountryPhonePostalInfoRepository.ValidatePhoneNumber("United States", string.Empty);
	...
	{
		var result = CountryPhonePostalInfoRepository.ValidatePostalCode("United States", string.Empty);
