...
// Last Modified On : 06-29-2025
// ***********************************************************************
// <copyright file="SimpleResult.cs" company="dotNetTips.com - McCarter Consulting">
...
public static class SimpleResult
{
	...
	/// <summary>
	/// Creates a new instance of <see cref="SimpleResult{T}" /> from the specified exception with a unsuccessful result.
	/// </summary>
	...
	/// <summary>
	/// Creates a new instance of <see cref="SimpleResult{T}" /> from the specified value with a successful result.
	/// </summary>
	/// <typeparam name="T">The type of the value.</typeparam>
	...
	[return: NotNull]
	[Information(nameof(SimpleResult), UnitTestStatus = UnitTestStatus.Completed, Status = Status.Available)]
	public static SimpleResult<T> FromValue<T>([DisallowNull] T value) => new(value);
}
