...
M00_L02:
       ...
       mov       rcx,r10
       mov       rdx,rsi
       call      qword ptr [7FF7A95260A0]; System.Enum.Equals(System.Object)
M00_L03:
       test      eax,eax
       je        near ptr M00_L12
M00_L04:
...
M00_L09:
       ...
       call      qword ptr [7FF7A95E6BB0]; System.MulticastDelegate.CtorClosed(System.Object, IntPtr)
       mov       rcx,2452D002110
       mov       rdx,rdi
       call      CORINFO_HELP_ASSIGN_REF
...
M00_L18:
       ...
       mov       r8,rsi
       mov       rcx,r14
       call      qword ptr [7FF7A996C4F8]; System.Collections.Concurrent.ConcurrentDictionary`2[[System.__Canon, System.Private.CoreLib],[System.__Canon, System.Private.CoreLib]].TryAddInternal(Tables<System.__Canon,System.__Canon>, System.__Canon, System.Nullable`1<Int32>, System.__Canon, Boolean, Boolean, System.__Canon ByRef)
...
M01_L00:
       ...
       lea       rsi,[rbx+8]
       lea       rdi,[rdx+8]
       call      00007FF80920F240
       add       eax,0FFFFFFFE
       cmp       eax,17
       ja        short M01_L03
       lea       rcx,[7FF7A9D42DB0]
       mov       ecx,[rcx+rax*4]
       lea       rdx,[M01_L00]
       add       rcx,rdx
       jmp       rcx
...
M02_L00:
       mov       rcx,[rbp-8]
       mov       rdx,[rbp+18]
       call      qword ptr [7FF7A9CC54E8]; System.Enum.GetName(System.Type, System.Object)
       mov       [rbp-10],rax
; 			if (name == null)
; 			^^^^^^^^^^^^^^^^^
...
M02_L01:
       ...
       mov       rdx,[rbp-10]
       cmp       [rcx],ecx
       call      qword ptr [7FF7A9CC5500]; System.Type.GetField(System.String)
       mov       [rbp-18],rax
; 			if (field == null)
; 			^^^^^^^^^^^^^^^^^^
       mov       rcx,[rbp-18]
       xor       edx,edx
       call      qword ptr [7FF7A9CC5518]; System.Reflection.FieldInfo.op_Equality(System.Reflection.FieldInfo, System.Reflection.FieldInfo)
       test      eax,eax
       je        short M02_L02
; 				return name;
; 				^^^^^^^^^^^^
...
M02_L02:
       mov       rdx,[rbp-18]
       mov       rcx,7FF7A9CD8F78
       xor       r8d,r8d
       call      qword ptr [7FF7A9AE5E90]; System.Reflection.CustomAttributeExtensions.GetCustomAttribute[[System.__Canon, System.Private.CoreLib]](System.Reflection.MemberInfo, Boolean)
       mov       [rbp-20],rax
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,rax
       call      qword ptr [7FF7A987E2C8]; System.String.IsNullOrEmpty(System.String)
       test      eax,eax
       jne       short M02_L03
...
; 			^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
       ...
       mov       rcx,[rbp-28]
       cmp       [rcx],ecx
       call      qword ptr [7FF7A9CC5548]; System.Runtime.Serialization.EnumMemberAttribute.get_Value()
       mov       rcx,rax
       call      qword ptr [7FF7A987E2C8]; System.String.IsNullOrEmpty(System.String)
       test      eax,eax
       jne       short M02_L04
...
M04_L06:
       ...
       lea       rdx,[rbp-50]
       call      qword ptr [7FF83A9FAB78]; Precode of System.Threading.Monitor.Enter(System.Object, Boolean ByRef)
M04_L07:
       mov       rcx,[rbp+18]
       cmp       rcx,[rbx+8]
...
M04_L08:
       ...
       jne       short M04_L09
       mov       rcx,[rbx]
       call      qword ptr [7FF83A9FA3D8]
       mov       rcx,rax
       call      qword ptr [7FF83A9FA910]
       mov       rdx,[r13+8]
       mov       rcx,[rbp-60]
       mov       r11,rax
       mov       r8,[rbp+20]
...
M04_L12:
       ...
       mov       rdx,[r13+10]
       mov       rcx,[rbp+48]
       call      qword ptr [7FF83A9FA260]; CORINFO_HELP_CHECKED_ASSIGN_REF
       jmp       short M04_L14
M04_L13:
       lea       rcx,[r13+10]
       mov       rdx,[rbp+30]
...
M04_L20:
       ...
       call      qword ptr [7FF83A9FAB80]; Precode of System.Threading.Monitor.Exit(System.Object)
M04_L21:
       mov       ecx,edi
       or        ecx,r14d
       je        short M04_L22
...
; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetDescription_NoCache()
       ...
       mov       rcx,rax
       call      qword ptr [7FF7A9C0EE38]; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetDescriptionNoCache(System.Enum)
       mov       [rsp+28],rax
       mov       rbx,[rbx+60]
       mov       rdx,[rsp+28]
       lea       rcx,[rbx+8]
...
; DotNetTips.Spargine.Core.BenchmarkTests.EnumHelperBenchmark.GetDescriptionNoCache(System.Enum)
       ...
       je        near ptr M01_L49
       mov       rcx,rbx
       call      qword ptr [7FF7A97861D8]; System.Object.GetType()
       mov       rsi,rax
       mov       rcx,[rsi+18]
       test      cl,2
...
M01_L02:
       mov       rcx,rbx
       call      qword ptr [7FF7A9C0EF40]; System.Enum.ToUInt64(System.Object)
       mov       rdx,rax
       mov       rcx,rsi
       call      qword ptr [7FF7A9C0EFA0]; System.Enum.GetName(System.RuntimeType, UInt64)
       mov       rdi,rax
       test      rdi,rdi
       je        near ptr M01_L53
       mov       rcx,rsi
       mov       rdx,rdi
       mov       r8d,1C
       call      qword ptr [7FF7A94FA490]; System.RuntimeType.GetField(System.String, System.Reflection.BindingFlags)
       mov       rbx,rax
       test      rbx,rbx
...
M01_L13:
       ...
       mov       r8d,[rsp+0A0]
       mov       r9,29B61E706E8
       call      qword ptr [7FF7A9787840]; System.Reflection.CustomAttribute.GetCustomAttributes(System.Reflection.RuntimeModule, Int32, Int32, System.RuntimeType)
       mov       rsi,rax
...
M01_L19:
       mov       rcx,[rsp+40]
       call      qword ptr [7FF7A97877F8]; System.Runtime.CompilerServices.RuntimeHelpers.<GetHashCode>g__GetHashCodeWorker|15_0(System.Object)
...
M01_L21:
       ...
       mov       r8,rsi
       xor       edx,edx
       call      qword ptr [7FF7A9C74C30]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
...
M01_L23:
       ...
       cmp       [rsi],rcx
       je        short M01_L24
       call      qword ptr [7FF7A9784D38]; System.Runtime.CompilerServices.CastHelpers.ChkCastClassSpecial(Void*, System.Object)
       mov       rsi,rax
M01_L24:
       test      rsi,rsi
...
M01_L49:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FF7A9C7DD40]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FF7A9C767F0]
       mov       rcx,rsi
       call      CORINFO_HELP_THROW
       int       3
M01_L50:
       mov       rcx,rsi
       mov       rdx,29B61E66C10
       call      qword ptr [7FF7A94FA608]; System.RuntimeType.IsSubclassOf(System.Type)
...
M01_L52:
       mov       rcx,rsi
       call      qword ptr [7FF7A9C77D50]; System.Type.IsIntegerType(System.Type)
       test      eax,eax
       jne       near ptr M01_L02
       mov       rcx,offset MT_System.ArgumentException
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF7A9C77D68]
       mov       rsi,rax
       mov       ecx,3AD
...
M01_L56:
       ...
       mov       rcx,r13
       cmp       [rcx],ecx
       call      qword ptr [7FF7A97869B8]; System.RuntimeType.get_IsActualInterface()
       test      eax,eax
       jne       short M01_L58
       mov       rcx,r13
       call      00007FF8092028C0
...
M01_L60:
       ...
       jmp       near ptr M01_L04
M01_L61:
       call      qword ptr [7FF7A95B5C80]; System.RuntimeTypeHandle.GetRuntimeTypeFromHandleSlow(IntPtr)
       jmp       near ptr M01_L03
M01_L62:
       call      qword ptr [7FF7A9787618]; System.RuntimeType.GetBaseType()
       mov       rcx,rax
       test      rcx,rcx
...
M01_L63:
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rbx,rax
       call      qword ptr [7FF7A9C76CA0]
       mov       rdx,rax
       mov       rcx,rbx
       call      qword ptr [7FF7A9934138]
       mov       rcx,rbx
       call      CORINFO_HELP_THROW
       int       3
M01_L64:
...
M01_L65:
       ...
       mov       rdx,rsi
       xor       r8d,r8d
       call      qword ptr [7FF7A9ABC6C0]; System.Attribute.InternalGetCustomAttributes(System.Reflection.PropertyInfo, System.Type, Boolean)
       mov       r15,rax
...
M01_L71:
       mov       rcx,rsi
       call      qword ptr [7FF7A9785728]; System.RuntimeTypeHandle.<GetModule>g__GetModuleWorker|48_0(System.RuntimeType)
       mov       rcx,rax
