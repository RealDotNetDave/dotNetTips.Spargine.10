...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetInstances01()
       ...
       mov       [rsp+28],rax
       mov       rbx,rcx
       call      qword ptr [7FFA8AE1ED60]; System.Reflection.Assembly.GetExecutingAssembly()
       mov       rsi,rax
...
; DotNetTips.Spargine.Extensions.BenchmarkTests.AssemblyExtensionsBenchmark.GetTypes()
       ...
       mov       [rbp-40],rax
       mov       rbx,rcx
       call      qword ptr [7FFA8ADEE898]; System.Reflection.Assembly.GetExecutingAssembly()
       test      rax,rax
       je        near ptr M00_L25
       ...
       mov       rcx,rax
       call      qword ptr [7FFA8A7CC858]; System.Reflection.Assembly.GetTypes()
       mov       rsi,rax
M00_L00:
...
M00_L05:
       ...
       mov       r8d,1
       call      qword ptr [7FFA8A944BE8]; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       mov       r12d,eax
       jmp       near ptr M00_L15
M00_L06:
       mov       rdx,r15
       ...
       jne       short M00_L08
       mov       rcx,2C128B77000
       call      qword ptr [7FFA8A9469A0]; System.RuntimeType.get_IsActualInterface()
       test      eax,eax
       jne       near ptr M00_L17
       mov       rcx,2C128B77000
       call      00007FFAEA272C30
       test      eax,eax
       je        short M00_L09
       mov       rcx,2C128B77000
       call      qword ptr [7FFA8A5BA400]
       mov       r13d,[rax+8]
       test      r13d,r13d
       jle       short M00_L08
       lea       r12,[rax+10]
...
M00_L25:
       call      qword ptr [7FFA8AD4DC08]
       mov       ecx,3F
       mov       rdx,7FFA8AB96880
       call      qword ptr [7FFA8A67F210]
       mov       rbx,rax
       mov       ecx,1B61
       mov       rdx,7FFA8AA75B10
       call      qword ptr [7FFA8A67F210]
       mov       rdx,rax
       mov       rcx,rbx
       ...
       call      CORINFO_HELP_NEWSFAST
       mov       rsi,rax
       call      qword ptr [7FFA8AEB7C48]
       mov       r8,rax
       mov       rdx,rbx
       mov       rcx,rsi
       call      qword ptr [7FFA8AEB6EB0]
       mov       rcx,rsi
...
M00_L38:
       ...
       xor       edx,edx
       mov       [rsp+28],edx
       call      qword ptr [7FFA8AEB5278]; System.Array.CopyImpl(System.Array, Int32, System.Array, Int32, Int32, Boolean)
       jmp       near ptr M00_L22
       int       3
M00_L39:
...
M02_L13:
       ...
       mov       r9d,ebx
       xor       edx,edx
       call      qword ptr [7FFA8ACCC7B0]; System.Array.Copy(System.Array, Int32, System.Array, Int32, Int32)
       add       ebx,r15d
       inc       edi
M02_L14:
       cmp       [r14+8],edi
...
; System.Runtime.CompilerServices.TypeHandle.CanCastToWorker(System.Runtime.CompilerServices.TypeHandle, System.Runtime.CompilerServices.TypeHandle, Boolean)
       ...
       je        near ptr M03_L05
M03_L00:
       mov       rcx,7FFA8AF07B3C
       call      CORINFO_HELP_COUNTPROFILE32
M03_L01:
       mov       rcx,7FFA8AF07B44
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,rsi
       mov       rdx,rbx
       mov       rax,7FFA8A784948
       mov       [rbp-60],rax
       lea       rax,[M03_L02]
       mov       [rbp-50],rax
       lea       rax,[rbp-70]
...
M03_L05:
       ...
       jne       short M03_L07
M03_L06:
       mov       rcx,7FFA8AF07B38
       call      CORINFO_HELP_COUNTPROFILE32
       movzx     edi,dil
       jmp       short M03_L04
M03_L07:
       mov       rdx,rsi
       call      qword ptr [7FFA8AEB6898]
       test      eax,eax
       je        near ptr M03_L00
       jmp       short M03_L06
M03_L08:
       mov       rcx,7FFA8AF07B40
       call      CORINFO_HELP_COUNTPROFILE32
...
M08_L00:
       ...
       cmovl     edx,ecx
       mov       rcx,rbx
       call      qword ptr [7FFAEA0EDD70]; Precode of System.Collections.Generic.List`1[[System.__Canon, System.Private.CoreLib]].set_Capacity(Int32)
       mov       [rbx+10],ebp
       mov       rcx,[rbx+8]
       movsxd    rdx,edi
       mov       r8,rsi
       call      qword ptr [7FFAEA0C7FF0]; Precode of System.Runtime.CompilerServices.CastHelpers.StelemRef(System.Object[], IntPtr, System.Object)
       nop
       add       rsp,28
       pop       rbx
       pop       rbp
...
M09_L01:
       test      rbx,rbx
       jne       short M09_L04
       mov       rcx,7FFA8AED5484
       call      CORINFO_HELP_COUNTPROFILE32
M09_L02:
       mov       rcx,7FFA8AED548C
       call      CORINFO_HELP_COUNTPROFILE32
       mov       rcx,[rsi]
       mov       ecx,[rcx+4]
       add       ecx,0FFFFFFE8
...
M09_L04:
       ...
       cmp       r15,[rbx]
       je        short M09_L05
       mov       rcx,7FFA8AED5480
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L02
M09_L05:
       cmp       dword ptr [r15+4],18
       je        short M09_L06
       mov       rcx,7FFA8AED547C
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L02
M09_L06:
       cmp       edi,[rsi+8]
       jbe       short M09_L07
       mov       rcx,7FFA8AED5478
       call      CORINFO_HELP_COUNTPROFILE32
       jmp       short M09_L02
M09_L07:
       cmp       edi,[rbx+8]
       jbe       near ptr M09_L13
       mov       rcx,7FFA8AED5474
       call      CORINFO_HELP_COUNTPROFILE32
...
M09_L14:
       ...
       pop       r14
       pop       r15
       jmp       qword ptr [7FFA8AD4DAE8]
M09_L15:
       mov       rcx,7FFA8AED5488
       call      CORINFO_HELP_COUNTPROFILE32
       cmp       rdi,19
       jne       short M09_L16
